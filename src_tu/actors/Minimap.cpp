 ...
 *   [0] 0x020f975c  src/_ZN7MinimapD1Ev.cpp
 *   [1] 0x020f978c  src/_ZN7MinimapD0Ev.cpp
 *   [2] 0x020f97d0  src/_ZN7Minimap21FixTHIPaintingRoomPosER7Vector3.cpp
 *   [3] 0x020f99a8  src/_ZN7Minimap19UpdateLevelSpecificEv.cpp
 *   [4] 0x020f9e8c  src/_ZN7Minimap16CleanupResourcesEv.cpp
 *   [5] 0x020f9e94  src/_ZN7Minimap16OnPendingDestroyEv.cpp
 *   [6] 0x020f9e98  src/_ZN7Minimap6RenderEv.cpp
 *   [7] 0x020fa690  src/_ZN7Minimap8BehaviorEv.cpp
 *   [8] 0x020fb38c  src/_ZN7Minimap13InitResourcesEv.cpp
 *   [9] 0x020fb804  src/_ZN7Minimap20GetPosFromMinimapPosER7Vector3S1_5Fix12IiEsS1_.cpp
 *   [10] 0x020fb85c  src/_ZN7Minimap15GetPosOnMinimapER7Vector3S1_5Fix12IiEsS1_.cpp
 */
 ...
 *   _ZN7Minimap6RenderEv: #pragma opt_strength_reduction off   [NOT carried -- review]
 *   _ZN7Minimap13InitResourcesEv: #pragma opt_strength_reduction off   [NOT carried -- review]
 */
 ...
 * Minimap::Render and Minimap::InitResources. Carried file-globally it is a
...
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2f8, from the legacy file for _ZN7Minimap19UpdateLevelSpecificEv, NOT applied: extern s8 data_0209f2f8; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f250, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern u8   data_0209f250; */
/* TUBUILD CONFLICT -- alternate declaration of data_0208ee44, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern s32  data_0208ee44; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2c4, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern u8   data_0209f2c4; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f20c, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern u8   data_0209f20c; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f294, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern u8   data_0209f294; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209d660, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern u8   data_0209d660; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2d8, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern u8   data_0209f2d8; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2f8, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern s8   data_0209f2f8; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111148, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern s8   data_ov002_02111148; */
/* TUBUILD CONFLICT -- alternate declaration of SublevelToLevel, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern s32  SublevelToLevel(s32 i); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN4cstd4fdivEii, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern int _ZN4cstd4fdivEii(s32 a, s32 b); */
/* TUBUILD CONFLICT -- alternate declaration of Vec3_Sub, from the legacy file for _ZN7Minimap8BehaviorEv, NOT applied: extern void Vec3_Sub(Vector3 *out, Vector3 *a, Vector3 *b); */
/* TUBUILD CONFLICT -- alternate declaration of GetMinimapID, from the legacy file for _ZN7Minimap13InitResourcesEv, NOT applied: int GetMinimapID(void* obj, int arg); */
/* TUBUILD CONFLICT -- alternate declaration of GetMinimapScale, from the legacy file for _ZN7Minimap13InitResourcesEv, NOT applied: int GetMinimapScale(int idx); */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2d8, from the legacy file for _ZN7Minimap13InitResourcesEv, NOT applied: extern u8 data_0209f2d8; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f250, from the legacy file for _ZN7Minimap13InitResourcesEv, NOT applied: extern u8 data_0209f250; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111148, from the legacy file for _ZN7Minimap13InitResourcesEv, NOT applied: extern signed char data_ov002_02111148; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209d454, from the legacy file for _ZN7Minimap13InitResourcesEv, NOT applied: extern u8 data_0209d454; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111150, from the legacy file for _ZN7Minimap13InitResourcesEv, NOT applied: extern u8 data_ov002_02111150; */
/* TUBUILD CONFLICT -- alternate declaration of Vec3_Sub, from the legacy file for _ZN7Minimap20GetPosFromMinimapPosER7Vector3S1_5Fix12IiEsS1_, NOT applied: void Vec3_Sub(struct Vec3* out, struct Vec3* a, struct Vec3* b); */
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN7MinimapD1Ev, 0x020f975c, size 0x30 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN7MinimapD0Ev, 0x020f978c, size 0x44 */
/* -------------------------------------------------------------------------- */
 ...
 * mentions a heap.
 *
 * (No separate definition: the single ~Minimap() below emits the D0 and D1
 * variants together. A second spelled-out body here is a redefinition.)
 */

/* -------------------------------------------------------------------------- */
/* ROM ordinal 2 -- _ZN7Minimap21FixTHIPaintingRoomPosER7Vector3, 0x020f97d0, size 0x1d8 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 3 -- _ZN7Minimap19UpdateLevelSpecificEv, 0x020f99a8, size 0x4e4 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN7Minimap19UpdateLevelSpecificEv
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 4 -- _ZN7Minimap16CleanupResourcesEv, 0x020f9e8c, size 0x8 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 5 -- _ZN7Minimap16OnPendingDestroyEv, 0x020f9e94, size 0x4 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN7Minimap16OnPendingDestroyEv
/* recovered: named members + shared header, real C++ method */
/* Minimap::OnPendingDestroy() at 0x020f9e94 (ov002) -- vtable slot 12.
 * Empty override; the minimap does nothing when marked for destruction.
 */
void Minimap::OnPendingDestroy()
{
    (void)this;
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 6 -- _ZN7Minimap6RenderEv, 0x020f9e98, size 0x7f8 */
/* -------------------------------------------------------------------------- */
#pragma opt_strength_reduction off  /* carried from the legacy source of this member */
// @symbol _ZN7Minimap6RenderEv
int Minimap::Render()
{
    u8 a = data_0209f20c;
    u8 b = data_0209f2c4;
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 7 -- _ZN7Minimap8BehaviorEv, 0x020fa690, size 0xcfc */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 8 -- _ZN7Minimap13InitResourcesEv, 0x020fb38c, size 0x478 */
/* -------------------------------------------------------------------------- */
#pragma opt_strength_reduction off  /* carried from the legacy source of this member */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 9 -- _ZN7Minimap20GetPosFromMinimapPosER7Vector3S1_5Fix12IiEsS1_, 0x020fb804, size 0x58 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 10 -- _ZN7Minimap15GetPosOnMinimapER7Vector3S1_5Fix12IiEsS1_, 0x020fb85c, size 0x60 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN7Minimap15GetPosOnMinimapER7Vector3S1_5Fix12IiEsS1_
extern "C" {
void _ZN7Minimap15GetPosOnMinimapER7Vector3S1_5Fix12IiEsS1_(Vector3* out, Vector3* a, int s, short ang, Vector3* res)
{
    struct Vec3 v;
