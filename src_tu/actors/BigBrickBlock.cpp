 ...
 * ov002/BigBrickBlock  (14 function(s))
 *
 ...
 *   [0] 0x020b35a0  src/_ZN13BigBrickBlockD1Ev.cpp
 *   [1] 0x020b35e4  src/_ZN13BigBrickBlockD0Ev.cpp
 *   [2] 0x020b363c  src/_ZN13BigBrickBlock17NotifyLinkedActorEv.cpp
 *   [3] 0x020b36a0  src/_ZN13BigBrickBlock16HasNonzeroAngleXEv.cpp
 *   [4] 0x020b36b4  src/_ZN13BigBrickBlock15OnHitByMegaCharER6Player.cpp
 *   [5] 0x020b36dc  src/_ZN13BigBrickBlock8OnKickedER8dActor_c.cpp
 *   [6] 0x020b3788  src/_ZN13BigBrickBlock11OnAttacked2ER8dActor_c.cpp
 *   [7] 0x020b37ec  src/_ZN13BigBrickBlock11OnAttacked1ER8dActor_c.cpp
 *   [8] 0x020b382c  src/_ZN13BigBrickBlock15OnGroundPoundedER8dActor_c.cpp
 *   [9] 0x020b38a0  src/_ZN13BigBrickBlock4KillEv.cpp
 *   [10] 0x020b3ab0  src/_ZN13BigBrickBlock16CleanupResourcesEv.cpp
 *   [11] 0x020b3b14  src/_ZN13BigBrickBlock6RenderEv.cpp
 *   [12] 0x020b3c0c  src/_ZN13BigBrickBlock8BehaviorEv.cpp
 *   [13] 0x020b3d78  src/_ZN13BigBrickBlock13InitResourcesEv.cpp
 */
...
extern BigBrickBlockFileRow data_ov002_02108ab0[];  /* model handles,     0xc stride */
extern BigBrickBlockFileRow data_ov002_02108ab4[];  /* collision handles, 0xc stride */
...
CLPS_Block *clps);
/* TUBUILD CONFLICT -- alternate declaration of _ZN5Event6GetBitEj, from the legacy file for _ZN13BigBrickBlock8BehaviorEv, NOT applied: extern "C" int _ZN5Event6GetBitEj(unsigned int a); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN5Event6GetBitEj, from the legacy file for _ZN13BigBrickBlock13InitResourcesEv, NOT applied: int _ZN5Event6GetBitEj(u32 bit); */
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 13 -- _ZN13BigBrickBlock13InitResourcesEv, 0x020b3d78, size 0x2f4 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 12 -- _ZN13BigBrickBlock8BehaviorEv, 0x020b3c0c, size 0x16c */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 11 -- _ZN13BigBrickBlock6RenderEv, 0x020b3b14, size 0xf8 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 10 -- _ZN13BigBrickBlock16CleanupResourcesEv, 0x020b3ab0, size 0x64 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 9 -- _ZN13BigBrickBlock4KillEv, 0x020b38a0, size 0x210 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 8 -- _ZN13BigBrickBlock15OnGroundPoundedER8dActor_c, 0x020b382c, size 0x74 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 7 -- _ZN13BigBrickBlock11OnAttacked1ER8dActor_c, 0x020b37ec, size 0x40 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 6 -- _ZN13BigBrickBlock11OnAttacked2ER8dActor_c, 0x020b3788, size 0x64 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 5 -- _ZN13BigBrickBlock8OnKickedER8dActor_c, 0x020b36dc, size 0xac */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 4 -- _ZN13BigBrickBlock15OnHitByMegaCharER6Player, 0x020b36b4, size 0x28 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 3 -- _ZN13BigBrickBlock16HasNonzeroAngleXEv, 0x020b36a0, size 0x14 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 2 -- _ZN13BigBrickBlock17NotifyLinkedActorEv, 0x020b363c, size 0x64 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN13BigBrickBlockD0Ev, 0x020b35e4, size 0x58 */
/* -------------------------------------------------------------------------- */
 ...
 * mentions a heap.
 *
 * (No separate definition: the single ~BigBrickBlock() below emits the D0 and
 * D1 variants together. A second spelled-out body here is a redefinition.)
 */

/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN13BigBrickBlockD1Ev, 0x020b35a0, size 0x44 */
/* -------------------------------------------------------------------------- */
