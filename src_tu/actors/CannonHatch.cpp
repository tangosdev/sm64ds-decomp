 ...
 * ov002/CannonHatch  (8 function(s))
 *
 ...
 *   [0] 0x020bc8f4  src/_ZN11CannonHatchD1Ev.cpp
 *   [1] 0x020bc938  src/_ZN11CannonHatchD0Ev.cpp
 *   [2] 0x020bc990  src/func_ov002_020bc990.c
 *   [3] 0x020bc9b0  src/_ZN11CannonHatch16CleanupResourcesEv.cpp
 *   [4] 0x020bc9f4  src/_ZN11CannonHatch6RenderEv.cpp
 *   [5] 0x020bca78  src/_ZN11CannonHatch8BehaviorEv.cpp
 *   [6] 0x020bcc20  src/_ZN11CannonHatch13InitResourcesEv.cpp
 *   [7] 0x020bcccc  src/CannonHatch_Spawn.c
 */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 7 -- CannonHatch_Spawn, 0x020bcccc, size 0x30 */
/* -------------------------------------------------------------------------- */
...
int *CannonHatch_Spawn(void)
{
    ...
    if (p) { _ZN10dBgActor_cC2Ev(p); p[0] = (int)(_ZTV11CannonHatch + 2); }
    return p;
}
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 6 -- _ZN11CannonHatch13InitResourcesEv, 0x020bcc20, size 0xac */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 5 -- _ZN11CannonHatch8BehaviorEv, 0x020bca78, size 0x1a8 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 4 -- _ZN11CannonHatch6RenderEv, 0x020bc9f4, size 0x84 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 3 -- _ZN11CannonHatch16CleanupResourcesEv, 0x020bc9b0, size 0x44 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN11CannonHatchD0Ev, 0x020bc938, size 0x58 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN11CannonHatchD0Ev
/* Not defined here: identical to _ZN11CannonHatchD1Ev below (both legacy
 * files independently reconstructed the same real out-of-line
 * `CannonHatch::~CannonHatch(){}`) -- a plain D0/D1 collapse redefinition,
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN11CannonHatchD1Ev, 0x020bc8f4, size 0x44 */
/* -------------------------------------------------------------------------- */
