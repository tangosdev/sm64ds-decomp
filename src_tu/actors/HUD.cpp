 ...
 *   [0] 0x020fb8f8  src/_ZN3HUDD1Ev.cpp
 *   [1] 0x020fb928  src/_ZN3HUDD0Ev.cpp
 *   [2] 0x020fb96c  src/_ZN3HUD15RenderTimeTimerEv.cpp
 *   [3] 0x020fbdac  src/_ZN3HUD15CalculateDigitsEt.cpp
 *   [4] 0x020fbe38  src/_ZN3HUD15RenderLifeCountEv.cpp
 *   [5] 0x020fc04c  src/_ZN3HUD19RenderCameraButtonsEv.cpp
 *   [6] 0x020fc3c4  src/_ZN3HUD17RenderSilverStarsEv.cpp
 *   [7] 0x020fc458  src/_ZN3HUD15RenderStarCountEv.cpp
 *   [8] 0x020fc77c  src/_ZN3HUD14RenderRedCoinsEv.cpp
 *   [9] 0x020fc81c  src/_ZN3HUD15RenderCoinCountEv.cpp
 *   [10] 0x020fca18  src/_ZN3HUD13RenderVsTimerEv.cpp
 *   [11] 0x020fce9c  src/_ZN3HUD13UpdateVsTimerEv.cpp
 *   [12] 0x020fcfec  src/_ZN3HUD17RenderHealthMeterEv.cpp
 *   [13] 0x020fd218  src/_ZN3HUD17UpdateHealthMeterEv.cpp
 *   [14] 0x020fd5d4  src/_ZN3HUD16CleanupResourcesEv.cpp
 *   [15] 0x020fd5dc  src/_ZN3HUD16OnPendingDestroyEv.cpp
 *   [16] 0x020fd5e0  src/_ZN3HUD6RenderEv.cpp
 *   [17] 0x020fd7a4  src/_ZN3HUD8BehaviorEv.cpp
 *   [18] 0x020fda04  src/_ZN3HUD13InitResourcesEv.cpp
 */
...
/* shadow struct 'OamAttr' */
struct OamAttr; struct Matrix2x2;

/* shadow class 'OAM' -- stands in for include/OAM.h, which declares Render and
 * the five-argument RenderSub but none of these OamAttr statics. The legacy
 * sources spelled the same twelve objects this way, and a static data member
 * cannot be added to a class from outside it. The `namespace OAM` spelling the
 * other legacy file used is folded in below; both mangle to _ZN3OAM...E. */
class OAM {
public:
...
/* TUBUILD CONFLICT -- alternate body of struct 'HUD', from the legacy file for _ZN3HUD15RenderCoinCountEv, NOT applied:
struct HUD {
    char pad[0x74];
...
/* TUBUILD CONFLICT -- alternate body of struct 'HUD', from the legacy file for _ZN3HUD13UpdateVsTimerEv, NOT applied:
struct HUD {
    void UpdateVsTimer();
};
*/

/* TUBUILD CONFLICT -- alternate body of struct 'HUD', from the legacy file for _ZN3HUD8BehaviorEv, NOT applied:
struct HUD {
    int Behavior();
    void UpdateVsTimer();
...
/* TUBUILD CONFLICT -- alternate body of struct 'HUD', from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied:
struct HUD {
    char pad0[0x60];
    s16 unk60;
    s16 unk62;
...
void _ZN3HUD15RenderCoinCountEv(HUD *);
void _ZN3HUD13UpdateVsTimerEv(HUD *);
void _ZN3HUD19RenderCameraButtonsEv(HUD *);
...
void _ZN3HUD15RenderLifeCountEv(HUD *);
...
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii, from the legacy file for _ZN3HUD15RenderLifeCountEv, NOT applied: void _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(int sub, OamAttr* attr, int x, int y, int priority, int rotation, int scaleX, int scaleY, int a, int mode); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2, from the legacy file for _ZN3HUD15RenderLifeCountEv, NOT applied: void _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(int sub, OamAttr* attr, int x, int y, int priority, int rotation, void* matrix); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM5TIMESE, from the legacy file for _ZN3HUD15RenderStarCountEv, NOT applied: extern struct OamAttr _ZN3OAM5TIMESE; */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2, from the legacy file for _ZN3HUD15RenderStarCountEv, NOT applied: extern void _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(int b, struct OamAttr* attr, int x, int y, int a, int c, struct Matrix2x2* m); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii, from the legacy file for _ZN3HUD17RenderHealthMeterEv, NOT applied: extern void _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii( */
/* TUBUILD CONFLICT -- alternate declaration of func_02012790, from the legacy file for _ZN3HUD17UpdateHealthMeterEv, NOT applied: extern void func_02012790(int id); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN5Event6GetBitEj, from the legacy file for _ZN3HUD6RenderEv, NOT applied: int _ZN5Event6GetBitEj(unsigned int); */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2d8, from the legacy file for _ZN3HUD8BehaviorEv, NOT applied: extern u8 data_0209f2d8; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111178, from the legacy file for _ZN3HUD8BehaviorEv, NOT applied: extern u8 data_ov002_02111178; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2fc, from the legacy file for _ZN3HUD8BehaviorEv, NOT applied: extern u8 data_0209f2fc; */
/* TUBUILD CONFLICT -- alternate declaration of NumStars, from the legacy file for _ZN3HUD8BehaviorEv, NOT applied: int NumStars(); */
/* TUBUILD CONFLICT -- alternate declaration of GetOwnerLanguage, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: int GetOwnerLanguage(void); */
/* TUBUILD CONFLICT -- alternate declaration of NumStars, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: u8 NumStars(void); */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2d8, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern u8 data_0209f2d8; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2f8, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern s8 data_0209f2f8; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2fc, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern u8 data_0209f2fc; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f250, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern u8 data_0209f250; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111178, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern s8 data_ov002_02111178; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_0211117c[0], from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern u8 data_ov002_0211117c[0]; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111184, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern s8 data_ov002_02111184; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111188, from the legacy file for _ZN3HUD13InitResourcesEv, NOT applied: extern s16 data_ov002_02111188; */
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 18 -- _ZN3HUD13InitResourcesEv, 0x020fda04, size 0x750 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUD13InitResourcesEv
int HUD::InitResources()
{
    ...
    (*(s16 *)((char *)this + 0x66)) = 0xA;
    if (data_0209f2d8 == 1) var_r2 = 1;
    if (var_r2 != 0) {
        if (data_0209f2f8 == 0x33) (*(s16 *)((char *)this + 0x60)) = 0x1E;
        else if (data_0209f2f8 == 0x2B) *(volatile s16 *)((char *)this + 0x60) = 0x1E;
        else (*(s16 *)((char *)this + 0x60)) = 0x1E;
    } else {
        (*(s16 *)((char *)this + 0x60)) = 0x1E;
    }
    ...
    if (var_r1_2 != 0) {
        ...
        (*(s16 *)((char *)this + 0x6e)) = -0x3A;
        (*(s16 *)((char *)this + 0x70)) = (s16)(var_r0_2 + 0x120);
        (*(u8 *)((char *)this + 0x78)) = 1;
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 17 -- _ZN3HUD8BehaviorEv, 0x020fd7a4, size 0x260 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUD8BehaviorEv
int HUD::Behavior()
{
    int t;
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 16 -- _ZN3HUD6RenderEv, 0x020fd5e0, size 0x1c4 */
/* -------------------------------------------------------------------------- */
...
int HUD::Render()
{
    ...
    if (b) {
        ...
        if (((data_0209f2c4 | data_0209f20c | data_0209f294) & 0xff) == 0) {
            _ZN3HUD13RenderVsTimerEv(this);
            _ZN3HUD15RenderStarCountEv(this);
            _ZN3HUD15RenderCoinCountEv(this);
            _ZN3HUD19RenderCameraButtonsEv(this);
        } else {
            if (data_0209f204 != 0) {
                _ZN3HUD13RenderVsTimerEv(this);
            }
        ...
        if (((data_0209f2c4 | v | data_0209f294) & 0xff) == 0) {
            _ZN3HUD17RenderHealthMeterEv(this);
            if (_ZN5Event6GetBitEj(0x1d) == 0) {
                _ZN3HUD15RenderCoinCountEv(this);
                _ZN3HUD14RenderRedCoinsEv(this);
                _ZN3HUD17RenderSilverStarsEv(this);
                _ZN3HUD15RenderTimeTimerEv(this);
            }
            if (data_0209f284 != 0) {
            ...
            if (v != 0) {
                _ZN3HUD15RenderLifeCountEv(this);
                _ZN3HUD15RenderStarCountEv(this);
            }
        }
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 15 -- _ZN3HUD16OnPendingDestroyEv, 0x020fd5dc, size 0x4 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUD16OnPendingDestroyEv
/* recovered: named members + shared header, real C++ method */
/* HUD::OnPendingDestroy() at 0x020fd5dc (ov002) -- vtable slot 12.
 * Empty override; the HUD does nothing when marked for destruction.
 */
void HUD::OnPendingDestroy()
{
    (void)this;
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 14 -- _ZN3HUD16CleanupResourcesEv, 0x020fd5d4, size 0x8 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 13 -- _ZN3HUD17UpdateHealthMeterEv, 0x020fd218, size 0x3bc */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 12 -- _ZN3HUD17RenderHealthMeterEv, 0x020fcfec, size 0x22c */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 11 -- _ZN3HUD13UpdateVsTimerEv, 0x020fce9c, size 0x150 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUD13UpdateVsTimerEv
/* include/HUD.h does not declare this member, and a member cannot be added to
 * a class from outside it, so it takes the hand-mangled free-function form.
 * Same ABI: the object still arrives in r0. */
extern "C" void _ZN3HUD13UpdateVsTimerEv(HUD *self)
{
    unsigned short *q;
    unsigned int v;
    ...
    {
        data_ov002_02111188 = 0xb4;
        q = (unsigned short *)((int)self + 0x60);
        *q = *q - 1;
        v = *(unsigned short *)((char *)self + 0x60);
        if (v <= 3 && v != 0)
            func_02012790(0x28);
        if (*(unsigned short *)((char *)self + 0x60) == 0)
        {
            data_0209f204 = 1;
    ...
    if (*(unsigned short *)((char *)self + 0x60) > 3)
        return;
    if (*(unsigned short *)((char *)self + 0x66) < 0x30)
    {
        q = (unsigned short *)((int)self + 0x66);
        *q = *q + 4;
    }
    else
    {
        *(unsigned short *)((char *)self + 0x66) = 0x38;
    }
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 10 -- _ZN3HUD13RenderVsTimerEv, 0x020fca18, size 0x484 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 9 -- _ZN3HUD15RenderCoinCountEv, 0x020fc81c, size 0x1fc */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUD15RenderCoinCountEv
 ...
 */
extern "C" void _ZN3HUD15RenderCoinCountEv(HUD *self)
{
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 8 -- _ZN3HUD14RenderRedCoinsEv, 0x020fc77c, size 0xa0 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 7 -- _ZN3HUD15RenderStarCountEv, 0x020fc458, size 0x324 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 6 -- _ZN3HUD17RenderSilverStarsEv, 0x020fc3c4, size 0x94 */
/* -------------------------------------------------------------------------- */
 ...
 * data_0209f250 -- the same byte HUD::RenderRedCoins reads, where a non-zero
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 5 -- _ZN3HUD19RenderCameraButtonsEv, 0x020fc04c, size 0x378 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUD19RenderCameraButtonsEv
...
extern "C" void _ZN3HUD19RenderCameraButtonsEv(HUD *)
{
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 4 -- _ZN3HUD15RenderLifeCountEv, 0x020fbe38, size 0x214 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUD15RenderLifeCountEv
extern "C" void _ZN3HUD15RenderLifeCountEv(HUD *self)
{
    ...
    if (state >= 3 && state < 6) {
        _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(0, _ZN3OAM10LIFE_ICONSE[info->field_6d9], (*(s16 *)((char *)self + 0x6e)), 0xa, -1, 1, 0x1000, 0x1000, 0, -1);
        _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(0, &_ZN3OAM5TIMESE, (*(s16 *)((char *)self + 0x6e)) + 0x10, 0xa, -1, 1, 0);
        self->CalculateDigits((unsigned short)data_0209f2f4);
        int x = (*(s16 *)((char *)self + 0x6e)) + 0x18;
        for (int i = 0; i < 3; i++) {
            signed char d = self->mDigits[i];
            if (d >= 0) {
        ...
        _ZN3OAM9RenderSubEP7OamAttriiii(_ZN3OAM10LIFE_ICONSE[info->field_6d9], (*(s16 *)((char *)self + 0x6e)), 0xa, -1, 1);
        _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(1, &_ZN3OAM5TIMESE, (*(s16 *)((char *)self + 0x6e)) + 0x10, 0xa, -1, 1, 0);
        self->CalculateDigits((unsigned short)data_0209f2f4);
        int i;
        int x = (*(s16 *)((char *)self + 0x6e)) + 0x18;
        for (i = 0; i < 3; i++) {
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 3 -- _ZN3HUD15CalculateDigitsEt, 0x020fbdac, size 0x8c */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 2 -- _ZN3HUD15RenderTimeTimerEv, 0x020fb96c, size 0x440 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN3HUDD0Ev, 0x020fb928, size 0x44 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUDD0Ev
 ...
 * mentions a heap.
 *
 * (No separate definition: the single ~HUD() below emits the D0 and D1
 * variants together. A second spelled-out body here is a redefinition.)
 */

/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN3HUDD1Ev, 0x020fb8f8, size 0x30 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN3HUDD1Ev
