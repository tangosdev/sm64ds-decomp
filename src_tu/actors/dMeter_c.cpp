 ...
 *   [0] 0x020fb8f8  src/_ZN8dMeter_cD1Ev.cpp
 *   [1] 0x020fb928  src/_ZN8dMeter_cD0Ev.cpp
 *   [2] 0x020fb96c  src/_ZN8dMeter_c15RenderTimeTimerEv.cpp
 *   [3] 0x020fbdac  src/_ZN8dMeter_c15CalculateDigitsEt.cpp
 *   [4] 0x020fbe38  src/_ZN8dMeter_c15RenderLifeCountEv.cpp
 *   [5] 0x020fc04c  src/_ZN8dMeter_c19RenderCameraButtonsEv.cpp
 *   [6] 0x020fc3c4  src/_ZN8dMeter_c17RenderSilverStarsEv.cpp
 *   [7] 0x020fc458  src/_ZN8dMeter_c15RenderStarCountEv.cpp
 *   [8] 0x020fc77c  src/_ZN8dMeter_c14RenderRedCoinsEv.cpp
 *   [9] 0x020fc81c  src/_ZN8dMeter_c15RenderCoinCountEv.cpp
 *   [10] 0x020fca18  src/_ZN8dMeter_c13RenderVsTimerEv.cpp
 *   [11] 0x020fce9c  src/_ZN8dMeter_c13UpdateVsTimerEv.cpp
 *   [12] 0x020fcfec  src/_ZN8dMeter_c17RenderHealthMeterEv.cpp
 *   [13] 0x020fd218  src/_ZN8dMeter_c17UpdateHealthMeterEv.cpp
 *   [14] 0x020fd5d4  src/_ZN8dMeter_c16CleanupResourcesEv.cpp
 *   [15] 0x020fd5dc  src/_ZN8dMeter_c16OnPendingDestroyEv.cpp
 *   [16] 0x020fd5e0  src/_ZN8dMeter_c6RenderEv.cpp
 *   [17] 0x020fd7a4  src/_ZN8dMeter_c8BehaviorEv.cpp
 *   [18] 0x020fda04  src/_ZN8dMeter_c13InitResourcesEv.cpp
 */
...
/* TUBUILD CONFLICT -- alternate body of struct 'dMeter_c', from the legacy file for _ZN8dMeter_c15RenderCoinCountEv, NOT applied:
struct dMeter_c {
    char pad[0x74];
...
/* TUBUILD CONFLICT -- alternate body of struct 'dMeter_c', from the legacy file for _ZN8dMeter_c13UpdateVsTimerEv, NOT applied:
struct dMeter_c {
    void UpdateVsTimer();
};
*/

/* TUBUILD CONFLICT -- alternate body of struct 'dMeter_c', from the legacy file for _ZN8dMeter_c8BehaviorEv, NOT applied:
struct dMeter_c {
    int Behavior();
    void UpdateVsTimer();
...
/* TUBUILD CONFLICT -- alternate body of struct 'dMeter_c', from the legacy file for _ZN8dMeter_c13InitResourcesEv, NOT applied:
struct dMeter_c {
    char pad0[0x60];
    s16 unk60;
    s16 unk62;
...
void _ZN8dMeter_c15RenderCoinCountEv(dMeter_c *);
void _ZN8dMeter_c13UpdateVsTimerEv(dMeter_c *);
void _ZN8dMeter_c19RenderCameraButtonsEv(dMeter_c *);
...
void _ZN8dMeter_c15RenderLifeCountEv(dMeter_c *);
...
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii, from the legacy file for _ZN8dMeter_c15RenderLifeCountEv, NOT applied: void _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(int sub, OamAttr* attr, int x, int y, int priority, int rotation, int scaleX, int scaleY, int a, int mode); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2, from the legacy file for _ZN8dMeter_c15RenderLifeCountEv, NOT applied: void _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(int sub, OamAttr* attr, int x, int y, int priority, int rotation, void* matrix); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM5TIMESE, from the legacy file for _ZN8dMeter_c15RenderStarCountEv, NOT applied: extern struct OamAttr _ZN3OAM5TIMESE; */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2, from the legacy file for _ZN8dMeter_c15RenderStarCountEv, NOT applied: extern void _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(int b, struct OamAttr* attr, int x, int y, int a, int c, struct Matrix2x2* m); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii, from the legacy file for _ZN8dMeter_c17RenderHealthMeterEv, NOT applied: extern void _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii( */
/* TUBUILD CONFLICT -- alternate declaration of func_02012790, from the legacy file for _ZN8dMeter_c17UpdateHealthMeterEv, NOT applied: extern void func_02012790(int id); */
/* TUBUILD CONFLICT -- alternate declaration of _ZN5Event6GetBitEj, from the legacy file for _ZN8dMeter_c6RenderEv, NOT applied: int _ZN5Event6GetBitEj(unsigned int); */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2d8, from the legacy file for _ZN8dMeter_c8BehaviorEv, NOT applied: extern u8 data_0209f2d8; */
/* TUBUILD CONFLICT -- alternate declaration of data_ov002_02111178, from the legacy file for _ZN8dMeter_c8BehaviorEv, NOT applied: extern u8 data_ov002_02111178; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2fc, from the legacy file for _ZN8dMeter_c8BehaviorEv, NOT applied: extern u8 data_0209f2fc; */
/* TUBUILD CONFLICT -- alternate declaration of NumStars, from the legacy file for _ZN8dMeter_c8BehaviorEv, NOT applied: int NumStars(); */
/* TUBUILD CONFLICT -- alternate declaration of GetOwnerLanguage, from the legacy file for _ZN8dMeter_c13InitResourcesEv, NOT applied: int GetOwnerLanguage(void); */
/* TUBUILD CONFLICT -- alternate declaration of NumStars, from the legacy file for _ZN8dMeter_c13InitResourcesEv, NOT applied: u8 NumStars(void); */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2d8, from the legacy file for _ZN8dMeter_c13InitResourcesEv, NOT applied: extern u8 data_0209f2d8; */
/* TUBUILD CONFLICT -- alternate declaration of data_0209f2f8, from the legacy file for _ZN8dMeter_c13InitResourcesEv, NOT applied: extern s8 data_0209f2f8; */
...
body:
    if (t != false) {
        _ZN8dMeter_c13UpdateVsTimerEv(this);
    } else {
        int flags;
        int n;
...
int dMeter_c::Render()
{
    ...
    if (b) {
        ...
        if (((data_0209f2c4 | data_0209f20c | data_0209f294) & 0xff) == 0) {
            _ZN8dMeter_c13RenderVsTimerEv(this);
            _ZN8dMeter_c15RenderStarCountEv(this);
            _ZN8dMeter_c15RenderCoinCountEv(this);
            _ZN8dMeter_c19RenderCameraButtonsEv(this);
        } else {
            if (data_0209f204 != 0) {
                _ZN8dMeter_c13RenderVsTimerEv(this);
            }
        ...
        if (((data_0209f2c4 | v | data_0209f294) & 0xff) == 0) {
            _ZN8dMeter_c17RenderHealthMeterEv(this);
            if (_ZN5Event6GetBitEj(0x1d) == 0) {
                _ZN8dMeter_c15RenderCoinCountEv(this);
                _ZN8dMeter_c14RenderRedCoinsEv(this);
                _ZN8dMeter_c17RenderSilverStarsEv(this);
                _ZN8dMeter_c15RenderTimeTimerEv(this);
            }
            if (data_0209f284 != 0) {
            ...
            if (v != 0) {
                _ZN8dMeter_c15RenderLifeCountEv(this);
                _ZN8dMeter_c15RenderStarCountEv(this);
            }
        }
...
extern "C" void _ZN8dMeter_c13UpdateVsTimerEv(dMeter_c *self)
{
    unsigned short *q;
    unsigned int v;
 ...
 */
extern "C" void _ZN8dMeter_c15RenderCoinCountEv(dMeter_c *self)
{
...
extern "C" void _ZN8dMeter_c19RenderCameraButtonsEv(dMeter_c *)
{
...
extern "C" void _ZN8dMeter_c15RenderLifeCountEv(dMeter_c *self)
{
