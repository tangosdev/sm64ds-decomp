 ...
 * ov095/Flamethrower  (4 function(s))
 *
 ...
 *   [0] 0x0213682c  src/_ZN12FlamethrowerD1Ev.cpp
 *   [1] 0x02136884  src/_ZN12FlamethrowerD0Ev.cpp
 *   [2] 0x021368f0  src/_ZN12Flamethrower8BehaviorEv.cpp
 *   [3] 0x02136d60  src/_ZN12Flamethrower13InitResourcesEv.cpp
 */
 ...
 *   _ZN12Flamethrower8BehaviorEv: #pragma opt_strength_reduction off   [NOT carried -- review]
 *   _ZN12Flamethrower13InitResourcesEv: #pragma opt_strength_reduction off   [NOT carried -- review]
 */
...
/* TUBUILD CONFLICT -- alternate declaration of MulVec3Mat4x3, from the legacy file for _ZN12Flamethrower13InitResourcesEv, NOT applied: extern "C" void MulVec3Mat4x3(struct Vec3 *v, void *m, struct Vec3 *dst); */
/* TUBUILD CONFLICT -- alternate declaration of Vec3_Add, from the legacy file for _ZN12Flamethrower13InitResourcesEv, NOT applied: extern "C" void Vec3_Add(struct Vec3 *out, struct Vec3 *a, struct Vec3 *b); */
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 3 -- _ZN12Flamethrower13InitResourcesEv, 0x02136d60, size 0x174 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 2 -- _ZN12Flamethrower8BehaviorEv, 0x021368f0, size 0x470 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN12FlamethrowerD0Ev, 0x02136884, size 0x6c */
/* -------------------------------------------------------------------------- */
// @symbol _ZN12FlamethrowerD0Ev
/* (no separate definition: the single ~Flamethrower() below emits the D0 and
 * D1 variants together -- a hand-mangled D0 next to a real destructor is the
 * known mwccarm ICE, ELFgen.c:483.) */

/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN12FlamethrowerD1Ev, 0x0213682c, size 0x58 */
/* -------------------------------------------------------------------------- */
