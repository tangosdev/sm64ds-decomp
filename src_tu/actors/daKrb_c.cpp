 ...
 * ov084/daKrb_c+daKrb_c  (32 function(s))
 *
 ...
 *   [0] 0x02129020  src/_ZN7daKrb_cD1Ev.cpp
 *   [1] 0x02129070  src/_ZN7daKrb_cD0Ev.cpp
 *   [2] 0x021290d4  src/func_ov084_021290d4.c
 *   [3] 0x02129168  src/func_ov084_02129168.cpp
 *   [4] 0x02129238  src/func_ov084_02129238.cpp
 *   [5] 0x0212934c  src/func_ov084_0212934c.c
 *   [6] 0x02129498  src/func_ov084_02129498.c
 *   [7] 0x021294d0  src/func_ov084_021294d0.cpp
 *   [8] 0x021296b0  src/func_ov084_021296b0.c
 *   [9] 0x021296cc  src/func_ov084_021296cc.c
 *   [10] 0x02129864  src/func_ov084_02129864.c
 *   [11] 0x021298d0  src/func_ov084_021298d0.cpp
 *   [12] 0x02129a00  src/func_ov084_02129a00.c
 *   [13] 0x02129c9c  src/func_ov084_02129c9c.c
 *   [14] 0x02129cf4  src/func_ov084_02129cf4.c
 *   [15] 0x02129ed4  src/func_ov084_02129ed4.c
 *   [16] 0x0212a580  src/func_ov084_0212a580.cpp
 *   [17] 0x0212a6f8  src/func_ov084_0212a6f8.c
 *   [18] 0x0212a774  src/func_ov084_0212a774.c
 *   [19] 0x0212aab0  src/func_ov084_0212aab0.cpp
 *   [20] 0x0212ab48  src/func_ov084_0212ab48.c
 *   [21] 0x0212abd4  src/func_ov084_0212abd4.c
 *   [22] 0x0212af74  src/func_ov084_0212af74.c
 *   [23] 0x0212b2dc  src/func_ov084_0212b2dc.c
 *   [24] 0x0212b30c  src/_ZN7daKrb_c16OnAimedAtWithEggEv.cpp
 *   [25] 0x0212b344  src/func_ov084_0212b344.cpp
 *   [26] 0x0212b510  src/_ZN7daKrb_c16CleanupResourcesEv.cpp
 *   [27] 0x0212b5b8  src/_ZN7daKrb_c16OnPendingDestroyEv.cpp
 *   [28] 0x0212b5bc  src/_ZN7daKrb_c6RenderEv.cpp
 *   [29] 0x0212b6ec  src/_ZN7daKrb_c8BehaviorEv.cpp
 *   [30] 0x0212bc30  src/_ZN7daKrb_c13InitResourcesEv.cpp
 *   [31] 0x0212bfc0  src/_ZN7daKrb_c13OnYoshiTryEatEv.cpp
 */
...
/* The four two-word shared-file handles this TU reads. The legacy files
   ...
   them for the SAME symbol -- and tubuild applied several at once. One view
   serves every reader: the loaded file pointer is always the second word. */
...
/* TUBUILD CONFLICT -- alternate declaration of data_ov084_02130cf8, from the legacy file for _ZN7daKrb_c13InitResourcesEv, NOT applied: extern SharedFilePtr data_ov084_02130cf8; */
    ...
    if (r4 == 1) {
        ...
        if (_ZN11dCapEnemy_c16GetCapEatenOffItERK7Vector3(self, &v) != 0) {
            ...
            *(int *)(self + 0xa8) = 0x14000;
            _ZN15MaterialChanger7PrepareER8BMD_FileR8BMA_File(data_ov084_02130cf8[1], &data_ov084_0213088c);
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 25 -- func_ov084_0212b344, 0x0212b344, size 0x1cc */
/* -------------------------------------------------------------------------- */
...
int daKrb_c::InitResources()
{
    ...
    *(unsigned char*)(c + 0x466) = (*(unsigned int*)(c + 8) >> 0xc) & 0xf;
    ...
    if (_ZN9ModelBase7SetFileEP8BMD_Fileii(c + 0x370, data_ov084_02130cf8[1], 1, -1) == 0)
        return 0;

    if (_ZN11ShadowModel12InitCylinderEv(c + 0x3d4) == 0)
        return 0;

    MaterialChanger::Prepare(*(BMD_File*)data_ov084_02130cf8[1], *(BMA_File*)&data_ov084_0213089c);
    _ZN15MaterialChanger7SetFileER8BMA_Filei5Fix12IiEj(c + 0x3fc, &data_ov084_0213089c, 0x40000000, 0x1000, 0);
