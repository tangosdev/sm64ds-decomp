...
```
python tools/agentlock.py acquire --files src/actors/Actor.cpp include/dActor_c.h --note "migrating Actor" --ttl 1800
...
```
python tools/agentlock.py renew --files src/actors/Actor.cpp include/dActor_c.h --ttl 1800
```
