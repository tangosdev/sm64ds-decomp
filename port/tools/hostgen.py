...
# TYPE is a plain builtin spelling; the decomp never casts to anything else here.
...
def transform(text):
    ...
    return MMIO_DEREF.subn(lambda m: f"NTR_MMIO({m.group(1).strip()}, {m.group(2)})", text)
