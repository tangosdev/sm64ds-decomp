 ...
 * matched src emits the MSVC decoration (?InitResources@daObjWc_Obj03_c@@QAEHXZ ...),
 * while hal/actor_classes_ov029.cpp's vtable fill -- and the ROM's own name --
 * spell the Itanium C symbol _ZN15daObjWc_Obj03_c13InitResourcesEv. This TU bridges the
...
/* Square and Rectangle InitResources call Actor::GetWaterHeightWDW, matched as a
   C++ method (src/_ZN8dActor_c17GetWaterHeightWDWEv.cpp, //cpp) -- another face. */
struct dActor_c { int GetWaterHeightWDW(); };
...
/* id 96 ArrowLift's live table is _ZTV15daObjWc_Obj02_c */
int _ZN15daObjWc_Obj02_c13InitResourcesEv(void *s)
{ return ((FloatOnWaterPlatformWdwSquare *)s)->InitResources(); }
int _ZN15daObjWc_Obj02_c16CleanupResourcesEv(void *s)
{ return ((FloatOnWaterPlatformWdwSquare *)s)->CleanupResources(); }
int _ZN15daObjWc_Obj02_c8BehaviorEv(void *s)
{ return ((FloatOnWaterPlatformWdwSquare *)s)->Behavior(); }
int _ZN15daObjWc_Obj02_c6RenderEv(void *s)
{ return ((FloatOnWaterPlatformWdwSquare *)s)->Render(); }

/* id 97 WaterDiamond's live table is _ZTV9ArrowLift (Actor 31) */
int _ZN15daObjWc_Obj03_c13InitResourcesEv(void *s)
{ return ((ArrowLift *)s)->InitResources(); }
int _ZN15daObjWc_Obj03_c8BehaviorEv(void *s)
{ return ((ArrowLift *)s)->Behavior(); }
int _ZN15daObjWc_Obj03_c6RenderEv(void *s)
{ return ((ArrowLift *)s)->Render(); }
/* ArrowLift's D1 (_ZN15daObjWc_Obj03_cD1Ev.cpp) is a full C++ VIRTUAL destructor that
...
int _ZN15daObjWc_Obj04_c13InitResourcesEv(void *s)
{ return ((SwitchActivatedPlank *)s)->InitResources(); }
int _ZN15daObjWc_Obj04_c16CleanupResourcesEv(void *s)
...
DSSTATE_END
int _ZN8dActor_c17GetWaterHeightWDWEv(void *s)
{ return ((dActor_c *)s)->GetWaterHeightWDW(); }
