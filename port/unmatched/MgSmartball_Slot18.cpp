 ...
 *     02118aa8  mov   r3, #4
 *     02118aac  str   ip, [sp]
 *     02118ab0  bl    #0x205525c          _ZN3G2x13SetBlendAlphaEPVttttj
 *     02118ab4  mov   ip, #0xa
...
/* five parameters, which is what the mangled name says and what the ROM
   ...
   src/_ZN3G2x13SetBlendAlphaEPVttttj.cpp carries a sixth its body never
   reads; dScMgCurling_c's slot 18 declares five as well. */
void _ZN3G2x13SetBlendAlphaEPVttttj(volatile void *p, unsigned short a,
...
void _ZN16dScMgSmartball_c13OnYoshiTryEatEi(void *self)
{
