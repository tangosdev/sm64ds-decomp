...
/* func_ov002_020ef070 RETIRED (run link100, lane SEAT6, batch B6).
   The slot-23 twin of the slot-24 row above: same seats, same reading.
   The matched TU src/func_ov002_020ef070.cpp is seated in its place: port/tools/hostgen.py's VIRTUAL_CALL table, word 23 __fastcall, with
