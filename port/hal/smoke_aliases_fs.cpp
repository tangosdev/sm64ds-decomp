// port/hal/smoke_aliases_fs.cpp -- the __cdecl, static and data half of
// smoke_fs's link, as /alternatename rows copied verbatim from
...
// port/faces_sync_smoke_fs.txt, not a row here.
//
