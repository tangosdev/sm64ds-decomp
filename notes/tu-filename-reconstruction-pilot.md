...
The current `tools/tu_map.py --check` also has a pre-existing [ov063](../config/arm9/overlays/ov063/symbols.txt) validation
...
| `STAR_CAMERA` | [src/actors/StarCamera_Spawn.cpp](../src/actors/StarCamera_Spawn.cpp) | [ov002](../config/arm9/overlays/ov002/symbols.txt) `0x020e6c40..0x020ebf8c` | — | — | TU contains a broader Star family | — | no most-derived RTTI class for the factory |
...
| `TERESA` | [src/game/actors/daTrs_c/d_a_trs_factories.cpp](../src/game/actors/daTrs_c/d_a_trs_factories.cpp) | [ov063](../config/arm9/overlays/ov063/symbols.txt) `0x02115ee0..0x0211c600` | `d_a_trs.cpp` | — | later `d_a_*` family | — | same TU also yields `d_a_t_basket.cpp`; TU-map check has baseline failure |
| `BOSS_TERESA` | [src/game/actors/daTrs_c/d_a_trs_factories.cpp](../src/game/actors/daTrs_c/d_a_trs_factories.cpp) | same [ov063](../config/arm9/overlays/ov063/symbols.txt) TU | `d_a_trs.cpp` | — | same class as `TERESA` | — | multi-stem TU and two same-class profiles |
...
| `MG_CURLING` | [src/d_s_mg_curling.cpp](../src/d_s_mg_curling.cpp) | [ov006](../config/arm9/overlays/ov006/symbols.txt) `0x020e0638..0x020e3854` | `d_s_mg_curling.cpp` | same | local `cup -> curling -> curling2` sequence is compatible with related-family order | B- | boundaries are medium/high, not source proof |
| `MG_CURLING_J` | [src/d_s_mg_curling2.cpp](../src/d_s_mg_curling2.cpp) | [ov006](../config/arm9/overlays/ov006/symbols.txt) `0x020e6bf4..0x020e6c28` | `d_s_mg_curling2.cpp` | same | immediately follows the `d_s_mg_curling2` method interval | B- | factory-only interval; class and profile suffixes differ |

## WATERFALL ordering trace

The recovered local [ov002](../config/arm9/overlays/ov002/symbols.txt) sequence is:
