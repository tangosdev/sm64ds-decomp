...
| `KURIBO` | [src/d_a_krb_kuribo.c](../src/d_a_krb_kuribo.c) | [ov084](../config/arm9/overlays/ov084/symbols.txt) `0x02129020..0x0212c10c` | `d_a_krb.cpp` | same | one distinct stem | B- | duplicate class entries; left edge lacks confidence |
...
| `OBJ_MIP_KEY` | [src/d_a_obj_mip_key.c](../src/d_a_obj_mip_key.c) | [ov085](../config/arm9/overlays/ov085/symbols.txt) `0x0212cc88..0x0212d528` | `d_a_obj_mip_key.cpp` | same | class family plus high/high boundaries | B | TU-name tool has no surviving stem for this interval |
