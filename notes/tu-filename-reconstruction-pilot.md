...
| `TERESA` | `src/game/actors/daTrs_c/d_a_trs_factories.cpp` | ov063 `0x02115ee0..0x0211c600` | `d_a_trs.cpp` | — | later `d_a_*` family | — | same TU also yields `d_a_t_basket.cpp`; TU-map check has baseline failure |
| `BOSS_TERESA` | `src/game/actors/daTrs_c/d_a_trs_factories.cpp` | same ov063 TU | `d_a_trs.cpp` | — | same class as `TERESA` | — | multi-stem TU and two same-class profiles |
