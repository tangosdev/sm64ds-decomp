...
from the [pre-promotion report](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/notes/plan-tu-merge-queue.md).
...
**The `+ 2` must be inside the cast.** [the archived PoleLift shadow](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src_tu/actors/PoleLift.cpp) documents this in a
17-line comment that predates this plan. The current promoted factory uses `return new`
and no longer contains that manual vptr-store explanation. Roughly **88 of the 100 Tier-1 TUs** hand-store a
