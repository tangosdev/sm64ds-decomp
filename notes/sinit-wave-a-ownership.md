...
## 1. da1up_c ([ov002](../config/arm9/overlays/ov002/symbols.txt):`3`)

The cartridge names this class: [ov002](../config/arm9/overlays/ov002/symbols.txt) holds the *Itanium type-name* string
...
The ROM `.ctor` entry is [.p__sinit_ov002_02100adc](../config/arm9/overlays/ov002/symbols.txt) at `0x021080d8`, between
`dEnemyBase_c` (`0x021080d4`) and the medium-confidence Coin initializer
(`0x021080dc`).  [ov002](../config/arm9/overlays/ov002/symbols.txt) has 26 initializers/26 ctor entries but 71 inferred TUs,
...
## 2. daObjKurumajiku_c ([ov002](../config/arm9/overlays/ov002/symbols.txt):`28`)
...
The second half copies four PMFs into [data_ov063_0211efbc](../config/arm9/overlays/ov063/symbols.txt) in this order:
