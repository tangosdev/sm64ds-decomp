...
**What it is not:** a build change. [PoleLift.cpp (archived shadow)](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src_tu/actors/PoleLift.cpp) is not enrolled,
...
The [original OK transcript](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/notes/tu-reconstruction-pilot-report.md#L49-L57) retains its exact
source-path spelling. The table below links archived source snapshots under those
historical names. Their archive commits are not claimed as the measured revisions;
the original measurement commit was not recorded.

| Result | Archived source | Compiler |
| --- | --- | --- |
| OK | [_ZN8PoleLiftD1Ev.cpp](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLiftD1Ev.cpp) | `2004/b56` |
| OK | [_ZN8PoleLiftD0Ev.cpp](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLiftD0Ev.cpp) | `2004/b56` |
| OK | [_ZN8PoleLift16CleanupResourcesEv.cpp](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLift16CleanupResourcesEv.cpp) | `2004/b56` |
| OK | [_ZN8PoleLift6RenderEv.cpp](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLift6RenderEv.cpp) | `2004/b56` |
| OK | [_ZN8PoleLift8BehaviorEv.cpp](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLift8BehaviorEv.cpp) | `2004/b56` |
| OK | [_ZN8PoleLift13InitResourcesEv.cpp](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLift13InitResourcesEv.cpp) | `2004/b56` |
| OK | [PoleLift_Spawn.c](https://github.com/tangosdev/sm64ds-decomp/blob/458c9f281496f5fef5768ad8707741a553ca42ff/src/PoleLift_Spawn.c) | `2004/b56` |
...
| Shadow source | [PoleLift.cpp (archived shadow)](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src_tu/actors/PoleLift.cpp) (`//cpp`, so C++) |
...
[PoleLift.cpp (archived shadow)](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src_tu/actors/PoleLift.cpp) is therefore written **bottom-to-top against the ROM**
...
In the legacy tree the two never meet: [the archived PoleLift_Spawn.c](https://github.com/tangosdev/sm64ds-decomp/blob/458c9f281496f5fef5768ad8707741a553ca42ff/src/PoleLift_Spawn.c) is a **C** TU that
only ever references an external `_ZTV8PoleLift`, so addend 0 is right; and
[the historical D1 source](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLiftD1Ev.cpp) defines the vtable, but `objisolate` strips it,
...
1. **`_ZN8PoleLiftD2Ev` has nowhere to go.** It is `0x4c` of `STB_GLOBAL` `.text`
   ...
   [the historical D1 source](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src/_ZN8PoleLiftD1Ev.cpp) compiled alone emits the identical D2 today, and
...
| Path | |
| --- | --- |
| [PoleLift.cpp (archived shadow)](https://github.com/tangosdev/sm64ds-decomp/blob/c67ec9fe1195e8594bae076451a2bbde670fa98e/src_tu/actors/PoleLift.cpp) | new — the shadow TU, not enrolled |
