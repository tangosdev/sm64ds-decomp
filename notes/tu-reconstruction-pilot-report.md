...
**What it is not:** a build change. `src/game/actors/d_a_obj_km2_ami_bou.cpp` is not enrolled,
...
`src/game/actors/d_a_obj_km2_ami_bou.cpp` is therefore written **bottom-to-top against the ROM**
