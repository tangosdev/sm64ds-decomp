...
| 272 | BIG_SNOWMAN | `_ZTS11daBgSnwmn_c` ([ov072](../config/arm9/overlays/ov072/symbols.txt)) | `Bg` + `Snwmn` = "Big Snowman" — the parent/manager actor over `daBgSnmHed_c` (273) and `daBgSnmBdy_c` (274), which *are* glossed. This is the missing third member of that family. |
| 334 | METER | `_ZTS8dMeter_c` ([ov002](../config/arm9/overlays/ov002/symbols.txt)) | dMeter_c meter/gauge object — exact match to the debug string. Likely the power-flower or timer meter. |
