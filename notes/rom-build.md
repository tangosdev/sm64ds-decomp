...
| 711 | the object defines a different symbol than the file/config name (e.g. `src/func_ov091_02132a0c.c` defines [daDsn_c_OnAimedAtWithEgg](../src/_ZN7daDsn_c16OnAimedAtWithEggEv.cpp)) — a src/config naming drift, likely recoverable by reconciling names. |
