...
each one settled by reading the body; `src/game/actors/ChillBully/_ZN10ChillBullyD0Ev.cpp` and
`src/game/actors/LavaSeesaw/_ZN10LavaSeesawD0Ev.cpp` carry the reasoning in their headers. All 31
