...
| 0x71a | `mPressedThisFrame` | gates that countdown, and the last statement of every `Behavior` clears it. `HandleClsn` sets it when a player or crate stands on the switch (`other.mPosY > mPosY + 0x64000`). |
