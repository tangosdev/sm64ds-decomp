...
`src/actors/BlueCoinSwitch.cpp`,
`src/actors/BlueCoinSwitch.cpp`, `src/actors/BlueCoinSwitch.cpp`,
`src/actors/BlueCoinSwitch.cpp`.
...
The rename carried into `src/actors/BlueCoinSwitch.cpp` as well as `src/` — the
...
The rename carried into `src/actors/daObjCannonShutter_c.cpp`, along with the same
...
The rename carried into `src/actors/ArrowSignRight.cpp` as well as `src/`.
