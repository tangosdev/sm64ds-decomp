...
- claim: `src/game/actors/d_a_obj_wc_obj01.cpp:18-21` keeps
...
```text
.venv/bin/python tools/match.py --c src/game/actors/d_a_obj_wc_obj01.cpp \
  --func _ZN14daObjWcObj01_c13InitResourcesEv --addr 0x02111254 --size 0xec \
  --version 2004/b56 --module ov029 --strict-relocs --brief
```

- result: baseline MATCH; variant 999 word(s) differ, size 0xec vs 0x10c
  (236 -> 268 bytes). Clean Vector3 + method-return form DIFFs as claimed.
- log (variant):

```text
TARGET _ZN14daObjWcObj01_c13InitResourcesEv @ 0x02111254 size 0xec  bytes: 70402de9a0d04de2d8109fe50040a0e1fb92feeb000050e32e00000a0400a0e113fbfbeb601094e50060a0e1060051e11e0000da24008de24799fceb5c5094e5... (236 bytes)
