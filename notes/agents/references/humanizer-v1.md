# Historical source-review measurements (reference only)

Use [the current source-review role](../roles/humanizer.md). The measured compiler
cases below remain useful; old stage boundaries and general style claims are not
evidence about the original source.
