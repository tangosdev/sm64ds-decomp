# Historical builder measurements (reference only)

Operational instructions are superseded by [the current protocol](../PIPELINE.md)
and [verifier role](../roles/verifier.md). Search this file for a specific gate or
compiler case; historical counts and command sequences require current verification.
