# Historical scout measurements (reference only)

Use [the current scout role](../roles/scout.md) for new work. The observations below
are retained as references; old claim commands and blanket extent rules are obsolete.
