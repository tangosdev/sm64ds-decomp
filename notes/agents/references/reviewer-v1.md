# Historical reviewer instructions (reference only)

Use [the current verifier role](../roles/verifier.md) and
[integrator role](../roles/integrator.md). The old operational rules below are
retained for provenance, not for launching or merging work.
