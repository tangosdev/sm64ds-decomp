...
| Offset | Name | Evidence |
| --- | --- | --- |
| 0x53d6 | `mSelectedTile` | Render draws the cursor sprite at [data_ov006_02142ab4](../config/arm9/overlays/ov006/symbols.txt)`[n]` / [_02142ab8](../config/arm9/overlays/ov006/symbols.txt)`[n]` (the tile coordinate tables, stride 8); Behavior hands the same value to `func_ov006_02108b90` (part of:[dScMgRoulette_c.cpp](../src/actors/dScMgRoulette_c.cpp), func 21 used to assemble TU) once per racer to score the board. |
