...
| Physical production source files | 10980 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10980 |
...
| Source-built (`complete`) source files | 10753 |
| Complete sources owning more than one function | 36 |
| Source-built records inside multi-function sources | 375 |
