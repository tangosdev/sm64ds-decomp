...
| Physical production source files | 10178 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10178 |
| Tracked `.c` files | 5876 |
| Tracked `.cpp` files | 4302 |
...
| Source-built (`complete`) source files | 9959 |
| Complete sources owning more than one function | 109 |
| Source-built records inside multi-function sources | 1274 |
...
| Functions named by manifest entries | 1984 |
| Unique functions named by the manifest | 1973 |
