...
| Strict CONVERTED source functions | 2709 / 11357 (23.85%) |
| Physical production source files | 9067 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9067 |
| Tracked `.c` files | 5206 |
| Tracked `.cpp` files | 3861 |
...
| Source-built (`complete`) source files | 8909 |
| Complete sources owning more than one function | 138 |
| Source-built records inside multi-function sources | 2433 |
...
| Functions named by manifest entries | 3074 |
| Unique functions named by the manifest | 3063 |
