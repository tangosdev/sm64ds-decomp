...
| Strict CONVERTED source functions | 2710 / 11357 (23.86%) |
| Physical production source files | 9054 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9054 |
| Tracked `.c` files | 5200 |
| Tracked `.cpp` files | 3854 |
...
| Source-built (`complete`) source files | 8896 |
| Complete sources owning more than one function | 138 |
| Source-built records inside multi-function sources | 2446 |
...
| Functions named by manifest entries | 3087 |
| Unique functions named by the manifest | 3076 |
