...
| Physical production source files | 10752 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10752 |
| Tracked `.c` files | 6137 |
| Tracked `.cpp` files | 4615 |
...
| Source-built (`complete`) source files | 10525 |
| Complete sources owning more than one function | 70 |
| Source-built records inside multi-function sources | 638 |
...
Manifest statuses: `link-verified` 3, `promoted` 69, `text-verified` 30.
