...
| Physical production source files | 9572 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9572 |
| Tracked `.c` files | 5506 |
| Tracked `.cpp` files | 4066 |
...
Manifest statuses: `link-verified` 3, `promoted` 117, `text-verified` 27.
