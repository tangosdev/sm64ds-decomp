...
| Strict CONVERTED source functions | 2679 / 11332 (23.64%) |
| Physical production source files | 10256 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10256 |
| Tracked `.c` files | 5921 |
| Tracked `.cpp` files | 4335 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3860 |
| Genuinely migrated C++ symbol files | 3776 |
| Not semantically migrated | 82 |
...
| Source-built (`complete`) source files | 10035 |
| Complete sources owning more than one function | 106 |
| Source-built records inside multi-function sources | 1187 |
| Largest function-symbol-records-per-source count | 52 |
...
Manifest statuses: `link-verified` 3, `promoted` 105, `shadow` 1, `text-verified` 27.
