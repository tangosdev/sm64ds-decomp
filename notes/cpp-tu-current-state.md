...
Current complete multi-function owners: `src/actors/ActorBase_SceneNode.cpp` (2 function-symbol records), `src/actors/ActorDerived.cpp` (5 function-symbol records), `src/actors/d_a_obj_km3_kuruma.cpp` (5 function-symbol records), `src/actors/daBar_c.cpp` (8 function-symbol records), `src/actors/daBrq_c.cpp` (18 function-symbol records), `src/actors/daEyBm_c.cpp` (13 function-symbol records), `src/actors/daKpFr_c.cpp` (21 function-symbol records), `src/actors/daKrpa_c.cpp` (25 function-symbol records), `src/actors/daObjAbuku_c.cpp` (7 function-symbol records), `src/actors/daObjC1_Trap_c.cpp` (17 function-symbol records), and 84 more in `--json`.
