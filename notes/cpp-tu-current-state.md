...
| Physical production source files | 9911 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9911 |
| Tracked `.c` files | 5766 |
| Tracked `.cpp` files | 4145 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3860 |
| Genuinely migrated C++ symbol files | 3727 |
| Not semantically migrated | 129 |
| `.cpp` files still hand-spelling their symbol | 63 |
...
| Source-built (`complete`) function-symbol records | 11127 |
| Source-built (`complete`) source files | 9695 |
| Complete sources owning more than one function | 110 |
| Source-built records inside multi-function sources | 1542 |
...
| Functions named by manifest entries | 2252 |
| Unique functions named by the manifest | 2241 |
