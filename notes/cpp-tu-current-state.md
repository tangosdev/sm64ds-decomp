...
| Physical production source files | 9061 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9061 |
| Tracked `.c` files | 5213 |
| Tracked `.cpp` files | 3848 |
...
| Source-built (`complete`) source files | 8903 |
| Complete sources owning more than one function | 138 |
| Source-built records inside multi-function sources | 2439 |
...
| Functions named by manifest entries | 3080 |
| Unique functions named by the manifest | 3069 |
| Modules represented | 47 |
| Manifest shadow sources present in git | 173 |
| Entries licensing non-text sections | 29 |
| Entries actually production-enrolled at `promoted_source` | 142 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 3, `promoted` 137, `text-verified` 33.
