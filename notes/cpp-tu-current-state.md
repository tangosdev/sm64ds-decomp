...
| Physical production source files | 11141 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11141 |
| Tracked `.c` files | 6338 |
| Tracked `.cpp` files | 4803 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3586 |
| Genuinely migrated C++ symbol files | 3512 |
...
| Source-built (`complete`) source files | 10914 |
| Complete sources owning more than one function | 25 |
| Source-built records inside multi-function sources | 203 |
...
| Measure | Live value |
| --- | ---: |
| Tracked `src_tu/` source files | 68 |
| Manifest entries | 92 |
| Functions named by manifest entries | 1137 |
| Unique functions named by the manifest | 1137 |
...
Manifest statuses: `link-verified` 3, `promoted` 24, `text-verified` 65.
