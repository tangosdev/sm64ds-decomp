...
| Physical production source files | 11000 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11000 |
| Tracked `.c` files | 6261 |
| Tracked `.cpp` files | 4739 |
...
| Source-built (`complete`) source files | 10773 |
| Complete sources owning more than one function | 33 |
| Source-built records inside multi-function sources | 352 |
...
Manifest statuses: `link-verified` 3, `promoted` 32, `text-verified` 62.
