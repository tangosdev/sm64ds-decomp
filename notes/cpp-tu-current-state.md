...
| Physical production source files | 10988 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10988 |
| Tracked `.c` files | 6195 |
| Tracked `.cpp` files | 4793 |
...
| Source-built (`complete`) source files | 10761 |
| Complete sources owning more than one function | 34 |
| Source-built records inside multi-function sources | 365 |
...
| Measure | Live value |
| --- | ---: |
| Tracked `src_tu/` source files | 65 |
| Manifest entries | 98 |
