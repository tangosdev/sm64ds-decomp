...
| Physical production source files | 9144 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9144 |
| Tracked `.c` files | 5245 |
| Tracked `.cpp` files | 3899 |
...
| Source-built (`complete`) source files | 8978 |
| Complete sources owning more than one function | 133 |
| Source-built records inside multi-function sources | 2352 |
...
| Functions named by manifest entries | 2978 |
| Unique functions named by the manifest | 2967 |
