...
| Physical production source files | 9298 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9298 |
| Tracked `.c` files | 5321 |
| Tracked `.cpp` files | 3977 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3975 |
| Genuinely migrated C++ symbol files | 3895 |
...
| Source-built (`complete`) source files | 9131 |
| Complete sources owning more than one function | 125 |
| Source-built records inside multi-function sources | 2189 |
...
| Functions named by manifest entries | 2815 |
| Unique functions named by the manifest | 2804 |
