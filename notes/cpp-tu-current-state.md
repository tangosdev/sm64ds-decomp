...
| Strict CONVERTED source functions | 2564 / 11314 (22.66%) |
| Physical production source files | 11022 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11022 |
...
| Source-built (`complete`) source files | 10795 |
| Complete sources owning more than one function | 32 |
| Source-built records inside multi-function sources | 329 |
...
| Entries actually production-enrolled at `promoted_source` | 27 |
| Existing promotion paths that disagree with delinks | 4 |

Manifest statuses: `link-verified` 3, `promoted` 31, `text-verified` 64.
