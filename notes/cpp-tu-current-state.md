...
| Physical production source files | 9268 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9268 |
| Tracked `.c` files | 5304 |
| Tracked `.cpp` files | 3964 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3998 |
| Genuinely migrated C++ symbol files | 3918 |
...
| Source-built (`complete`) source files | 9101 |
| Complete sources owning more than one function | 126 |
| Source-built records inside multi-function sources | 2221 |
...
| Functions named by manifest entries | 2847 |
| Unique functions named by the manifest | 2836 |
| Modules represented | 45 |
| Manifest shadow sources present in git | 155 |
| Entries licensing non-text sections | 17 |
| Entries actually production-enrolled at `promoted_source` | 125 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 3, `promoted` 125, `text-verified` 27.
