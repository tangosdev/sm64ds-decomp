...
| Physical production source files | 10300 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10300 |
| Tracked `.c` files | 5959 |
| Tracked `.cpp` files | 4341 |
...
| Source-built (`complete`) source files | 10079 |
| Complete sources owning more than one function | 106 |
| Source-built records inside multi-function sources | 1143 |
...
| Functions named by manifest entries | 1853 |
| Unique functions named by the manifest | 1842 |
