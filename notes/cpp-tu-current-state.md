...
| Strict CONVERTED source functions | 2568 / 11314 (22.70%) |
| Physical production source files | 11162 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11162 |
| Tracked `.c` files | 6343 |
| Tracked `.cpp` files | 4819 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3575 |
| Genuinely migrated C++ symbol files | 3501 |
...
| Source-built (`complete`) source files | 10935 |
| Complete sources owning more than one function | 23 |
| Source-built records inside multi-function sources | 180 |
...
| Manifest entries | 92 |
| Functions named by manifest entries | 1138 |
| Unique functions named by the manifest | 1138 |
| Modules represented | 28 |
| Manifest shadow sources present in git | 92 |
| Entries licensing non-text sections | 2 |
| Entries actually production-enrolled at `promoted_source` | 22 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 3, `promoted` 22, `text-verified` 67.
