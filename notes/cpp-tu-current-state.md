...
| Strict CONVERTED source functions | 2530 / 11314 (22.36%) |
| Physical production source files | 11189 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11189 |
| Tracked `.c` files | 6349 |
| Tracked `.cpp` files | 4840 |
...
| Source-built (`complete`) source files | 10962 |
| Complete sources owning more than one function | 20 |
| Source-built records inside multi-function sources | 150 |
...
| Entries actually production-enrolled at `promoted_source` | 19 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 3, `promoted` 19, `text-verified` 68.
