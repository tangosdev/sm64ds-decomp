...
| Physical production source files | 10179 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10179 |
| Tracked `.c` files | 5869 |
...
| Source-built (`complete`) source files | 9964 |
| Complete sources owning more than one function | 110 |
| Source-built records inside multi-function sources | 1275 |
...
| Functions named by manifest entries | 1985 |
| Unique functions named by the manifest | 1974 |
