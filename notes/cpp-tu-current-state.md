...
| Physical production source files | 10304 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10304 |
...
| Source-built (`complete`) source files | 10083 |
| Complete sources owning more than one function | 105 |
| Source-built records inside multi-function sources | 1134 |
...
| Functions named by manifest entries | 1844 |
| Unique functions named by the manifest | 1833 |
