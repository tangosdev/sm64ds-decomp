...
| Physical production source files | 10947 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10947 |
| Tracked `.c` files | 6190 |
| Tracked `.cpp` files | 4757 |
...
| Source-built (`complete`) source files | 10720 |
| Complete sources owning more than one function | 43 |
| Source-built records inside multi-function sources | 415 |
