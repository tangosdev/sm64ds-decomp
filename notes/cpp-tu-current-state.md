...
| Physical production source files | 9230 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9230 |
| Tracked `.c` files | 5285 |
| Tracked `.cpp` files | 3945 |
...
| Source-built (`complete`) source files | 9063 |
| Complete sources owning more than one function | 127 |
| Source-built records inside multi-function sources | 2260 |
...
| Functions named by manifest entries | 2886 |
| Unique functions named by the manifest | 2875 |
