...
| Physical production source files | 9187 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9187 |
| Tracked `.c` files | 5265 |
| Tracked `.cpp` files | 3922 |
...
| Source-built (`complete`) source files | 9020 |
| Complete sources owning more than one function | 128 |
| Source-built records inside multi-function sources | 2304 |
...
| Functions named by manifest entries | 2930 |
| Unique functions named by the manifest | 2919 |
