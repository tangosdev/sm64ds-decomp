...
| Physical production source files | 10299 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10299 |
| Tracked `.c` files | 5959 |
| Tracked `.cpp` files | 4340 |
...
| Source-built (`complete`) source files | 10078 |
| Complete sources owning more than one function | 106 |
| Source-built records inside multi-function sources | 1144 |
...
| Functions named by manifest entries | 1854 |
| Unique functions named by the manifest | 1843 |
