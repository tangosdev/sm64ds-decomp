...
| Strict CONVERTED source functions | 2715 / 11357 (23.91%) |
| Physical production source files | 9010 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9010 |
| Tracked `.c` files | 5186 |
| Tracked `.cpp` files | 3824 |
...
| Source-built (`complete`) source files | 8852 |
| Complete sources owning more than one function | 139 |
| Source-built records inside multi-function sources | 2491 |
...
| Functions named by manifest entries | 3132 |
| Unique functions named by the manifest | 3121 |
| Modules represented | 48 |
| Manifest shadow sources present in git | 174 |
| Entries licensing non-text sections | 29 |
| Entries actually production-enrolled at `promoted_source` | 143 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 3, `promoted` 138, `text-verified` 33.
