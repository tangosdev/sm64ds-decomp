...
| Strict CONVERTED source functions | 2696 / 11357 (23.74%) |
| Physical production source files | 9300 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9300 |
| Tracked `.c` files | 5317 |
| Tracked `.cpp` files | 3983 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3953 |
| Genuinely migrated C++ symbol files | 3873 |
...
| Source-built (`complete`) source files | 9133 |
| Complete sources owning more than one function | 125 |
| Source-built records inside multi-function sources | 2187 |
...
| Functions named by manifest entries | 2813 |
| Unique functions named by the manifest | 2802 |
