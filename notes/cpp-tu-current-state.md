...
| Physical production source files | 10084 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10084 |
| Tracked `.c` files | 5796 |
...
| Source-built (`complete`) source files | 9870 |
| Complete sources owning more than one function | 111 |
| Source-built records inside multi-function sources | 1371 |
...
Current complete multi-function owners: `src/actors/ActorBase_SceneNode.cpp` (2 function-symbol records), `src/actors/ActorDerived.cpp` (5 function-symbol records), `src/actors/dBgActor_c.cpp` (11 function-symbol records), `src/actors/dScGameOver_c.cpp` (9 function-symbol records), `src/actors/dScMgD3DBase_c.cpp` (27 function-symbol records), `src/actors/dScMgHanachan_c.cpp` (49 function-symbol records), `src/actors/dScMgRoulette_c.cpp` (40 function-symbol records), `src/actors/dScMgSound_c.cpp` (82 function-symbol records), `src/actors/dScMgTeresa_c.cpp` (48 function-symbol records), `src/actors/daDgr_c.cpp` (9 function-symbol records), and 101 more in `--json`.
...
| Functions named by manifest entries | 2081 |
| Unique functions named by the manifest | 2070 |
