...
| Strict CONVERTED source functions | 2256 / 11304 (19.96%) |
| Physical production source files | 11126 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11126 |
| Tracked `.c` files | 6479 |
| Tracked `.cpp` files | 4647 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3463 |
| Genuinely migrated C++ symbol files | 3298 |
| Not semantically migrated | 162 |
| `.cpp` files still hand-spelling their symbol | 101 |
...
| Source-built (`complete`) source files | 10886 |
| Complete sources owning more than one function | 27 |
| Source-built records inside multi-function sources | 210 |
...
Manifest statuses: `link-verified` 5, `promoted` 26, `text-verified` 57.
