...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9125 |
| Tracked `.c` files | 5234 |
| Tracked `.cpp` files | 3891 |
...
| Source-built (`complete`) source files | 8959 |
| Complete sources owning more than one function | 133 |
| Source-built records inside multi-function sources | 2371 |
...
| Functions named by manifest entries | 2997 |
| Unique functions named by the manifest | 2986 |
