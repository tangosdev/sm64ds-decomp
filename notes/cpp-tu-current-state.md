...
| Physical production source files | 10161 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10161 |
| Tracked `.c` files | 5866 |
| Tracked `.cpp` files | 4295 |
...
| Source-built (`complete`) function-symbol records | 11130 |
| Source-built (`complete`) source files | 9947 |
| Complete sources owning more than one function | 110 |
| Source-built records inside multi-function sources | 1293 |
...
Current complete multi-function owners: `src/actors/ActorBase_SceneNode.cpp` (2 function-symbol records), `src/actors/ActorDerived.cpp` (5 function-symbol records), `src/actors/dBgActor_c.cpp` (11 function-symbol records), `src/actors/dScGameOver_c.cpp` (9 function-symbol records), `src/actors/dScMgD3DBase_c.cpp` (27 function-symbol records), `src/actors/dScMgHanachan_c.cpp` (49 function-symbol records), `src/actors/dScMgRoulette_c.cpp` (40 function-symbol records), `src/actors/daBombking_c.cpp` (52 function-symbol records), `src/actors/daDgr_c.cpp` (9 function-symbol records), `src/actors/daDkk_c.cpp` (8 function-symbol records), and 100 more in `--json`.
...
| Functions named by manifest entries | 2003 |
| Unique functions named by the manifest | 1992 |
