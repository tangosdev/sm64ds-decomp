...
| Strict CONVERTED source functions | 2683 / 11317 (23.71%) |
| Physical production source files | 10407 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10407 |
| Tracked `.c` files | 5980 |
| Tracked `.cpp` files | 4427 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3858 |
| Genuinely migrated C++ symbol files | 3730 |
...
| Source-built (`complete`) source files | 10183 |
| Complete sources owning more than one function | 95 |
| Source-built records inside multi-function sources | 1010 |
...
| Functions named by manifest entries | 1720 |
| Unique functions named by the manifest | 1720 |
| Modules represented | 38 |
| Manifest shadow sources present in git | 126 |
| Entries licensing non-text sections | 17 |
| Entries actually production-enrolled at `promoted_source` | 94 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 4, `promoted` 94, `shadow` 1, `text-verified` 27.
