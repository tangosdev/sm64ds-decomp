...
| Physical production source files | 10311 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10311 |
| Tracked `.c` files | 5962 |
| Tracked `.cpp` files | 4349 |
...
| Source-built (`complete`) source files | 10090 |
| Complete sources owning more than one function | 104 |
| Source-built records inside multi-function sources | 1126 |
...
| Functions named by manifest entries | 1836 |
| Unique functions named by the manifest | 1825 |
| Modules represented | 39 |
| Manifest shadow sources present in git | 135 |
| Entries licensing non-text sections | 17 |
| Entries actually production-enrolled at `promoted_source` | 103 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 4, `promoted` 103, `shadow` 1, `text-verified` 27.
