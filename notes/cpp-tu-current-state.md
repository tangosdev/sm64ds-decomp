...
| Physical production source files | 9152 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9152 |
| Tracked `.c` files | 5251 |
| Tracked `.cpp` files | 3901 |
...
| Source-built (`complete`) source files | 8986 |
| Complete sources owning more than one function | 131 |
| Source-built records inside multi-function sources | 2342 |
...
| Functions named by manifest entries | 2968 |
| Unique functions named by the manifest | 2957 |
