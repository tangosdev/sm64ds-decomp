...
| Physical production source files | 9110 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9110 |
| Tracked `.c` files | 5230 |
| Tracked `.cpp` files | 3880 |
...
| Source-built (`complete`) source files | 8944 |
| Complete sources owning more than one function | 135 |
| Source-built records inside multi-function sources | 2388 |
...
| Functions named by manifest entries | 3024 |
| Unique functions named by the manifest | 3013 |
