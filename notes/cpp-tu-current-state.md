...
| Measure | Live value |
| --- | ---: |
| MATCHED functions | 11318 / 11390 (99.37%) |
| MATCHED code bytes | 2186936 / 2238108 (97.71%) |
| Strict CONVERTED source functions | 2707 / 11357 (23.84%) |
...
| Source-built (`complete`) source files | 8939 |
| Complete sources owning more than one function | 135 |
| Source-built records inside multi-function sources | 2400 |
...
| Functions named by manifest entries | 3041 |
| Unique functions named by the manifest | 3030 |
