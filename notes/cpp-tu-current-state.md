...
| Physical production source files | 9098 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9098 |
| Tracked `.c` files | 5228 |
| Tracked `.cpp` files | 3870 |
...
| Source-built (`complete`) source files | 8932 |
...
| Functions named by manifest entries | 3036 |
| Unique functions named by the manifest | 3025 |
