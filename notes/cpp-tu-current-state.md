...
| Physical production source files | 10743 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10743 |
| Tracked `.c` files | 6136 |
| Tracked `.cpp` files | 4607 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3685 |
| Genuinely migrated C++ symbol files | 3601 |
...
| Source-built (`complete`) source files | 10516 |
| Complete sources owning more than one function | 71 |
| Source-built records inside multi-function sources | 648 |
...
| Functions named by manifest entries | 1297 |
| Unique functions named by the manifest | 1297 |
| Modules represented | 30 |
