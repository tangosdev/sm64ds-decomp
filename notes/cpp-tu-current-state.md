...
| Physical production source files | 9097 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9097 |
| Tracked `.c` files | 5219 |
| Tracked `.cpp` files | 3878 |
...
| Source-built records inside multi-function sources | 2399 |
...
| Functions named by manifest entries | 3025 |
| Unique functions named by the manifest | 3014 |
