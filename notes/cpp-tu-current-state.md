...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9299 |
| Tracked `.c` files | 5313 |
| Tracked `.cpp` files | 3986 |
...
| Source-built (`complete`) source files | 9132 |
| Complete sources owning more than one function | 125 |
| Source-built records inside multi-function sources | 2188 |
...
| Functions named by manifest entries | 2814 |
| Unique functions named by the manifest | 2803 |
