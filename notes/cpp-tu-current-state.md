...
| Physical production source files | 9113 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9113 |
| Tracked `.c` files | 5232 |
| Tracked `.cpp` files | 3881 |
...
| Source-built (`complete`) source files | 8947 |
| Complete sources owning more than one function | 133 |
| Source-built records inside multi-function sources | 2383 |
...
| Functions named by manifest entries | 3009 |
| Unique functions named by the manifest | 2998 |
| Modules represented | 48 |
| Manifest shadow sources present in git | 162 |
| Entries licensing non-text sections | 20 |
| Entries actually production-enrolled at `promoted_source` | 132 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 3, `promoted` 132, `text-verified` 27.
