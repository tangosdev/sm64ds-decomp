...
| Physical production source files | 9126 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9126 |
| Tracked `.c` files | 5238 |
...
| Source-built (`complete`) source files | 8960 |
| Complete sources owning more than one function | 133 |
| Source-built records inside multi-function sources | 2370 |
...
| Functions named by manifest entries | 2996 |
| Unique functions named by the manifest | 2985 |
