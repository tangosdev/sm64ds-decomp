...
| Strict CONVERTED source functions | 2588 / 11314 (22.87%) |
| Physical production source files | 10978 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10978 |
| Tracked `.c` files | 6194 |
| Tracked `.cpp` files | 4784 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3683 |
| Genuinely migrated C++ symbol files | 3605 |
| Not semantically migrated | 75 |
| `.cpp` files still hand-spelling their symbol | 45 |
...
| Source-built (`complete`) source files | 10751 |
| Complete sources owning more than one function | 36 |
| Source-built records inside multi-function sources | 377 |
...
| Manifest entries | 98 |
| Functions named by manifest entries | 1258 |
