...
| Physical production source files | 10763 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10763 |
| Tracked `.c` files | 6140 |
| Tracked `.cpp` files | 4623 |
...
| Source-built (`complete`) source files | 10536 |
| Complete sources owning more than one function | 68 |
| Source-built records inside multi-function sources | 625 |
...
| Functions named by manifest entries | 1282 |
| Unique functions named by the manifest | 1282 |
| Modules represented | 30 |
| Manifest shadow sources present in git | 101 |
...
Manifest statuses: `link-verified` 3, `promoted` 67, `text-verified` 31.
