...
| Physical production source files | 9264 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9264 |
| Tracked `.c` files | 5301 |
| Tracked `.cpp` files | 3963 |
...
| Source-built (`complete`) source files | 9097 |
| Complete sources owning more than one function | 126 |
| Source-built records inside multi-function sources | 2225 |
...
| Functions named by manifest entries | 2851 |
| Unique functions named by the manifest | 2840 |
