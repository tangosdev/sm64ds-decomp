...
| Physical production source files | 10268 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10268 |
| Tracked `.c` files | 5931 |
| Tracked `.cpp` files | 4337 |
...
| Source-built (`complete`) source files | 10047 |
| Complete sources owning more than one function | 106 |
| Source-built records inside multi-function sources | 1175 |
...
| Functions named by manifest entries | 1885 |
| Unique functions named by the manifest | 1874 |
