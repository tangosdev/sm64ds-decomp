...
| Strict CONVERTED source functions | 2696 / 11358 (23.74%) |
| Physical production source files | 9301 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9301 |
| Tracked `.c` files | 5317 |
| Tracked `.cpp` files | 3984 |
...
| Source-built (`complete`) source files | 9134 |
