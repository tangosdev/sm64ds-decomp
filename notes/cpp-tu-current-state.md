...
| Strict CONVERTED source functions | 2683 / 11320 (23.70%) |
| Physical production source files | 10400 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10400 |
| Tracked `.c` files | 5979 |
| Tracked `.cpp` files | 4421 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3860 |
| Genuinely migrated C++ symbol files | 3733 |
...
| Source-built (`complete`) source files | 10174 |
| Complete sources owning more than one function | 96 |
| Source-built records inside multi-function sources | 1021 |
...
| Functions named by manifest entries | 1731 |
