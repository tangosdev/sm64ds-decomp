...
|---|---|---|---|
| ov006 func_ov006_02126ee4 (0x02126ee4, size 0xacc) | lunavyqo (Grok) | 2026-07-23 | **released** — improved near-miss **div=196** (was DB 393 / re-eval 606); size exact 0xacc; tip banked nearmiss/db.jsonl. API clm_9e7c5fd0650d released |
...
| ov002 func_ov002_020e7218 (0x020e7218, size 0xc0) | lunavyqo (Grok) | 2026-07-23 | **released** — improved near-miss **div=15** (was 19, size-matched); volatile temps + x-reload; residual add-order/ip sched. Tip banked. API clm_c3a5dc5566b0 released |
| ov004 func_ov004_020b38ac (0x020b38ac, size 0xcc) | lunavyqo (Grok) | 2026-07-23 | **released** — no_progress div=13 r5/r6 floor. API clm_c5435c59cd1b released |
...
| ov002 func_ov002_020d5c6c (0x020d5c6c, size 0x80) | lunavyqo (Grok) | 2026-07-23 | **active** — batch3 continue from div=7; API clm_f16785746b20 (was 17); u64-mask 0x6ce clear; pure r0/r1 regperm residual; tip banked; API clm_bd92d4f69ae5 released |
| ov006 func_ov006_020fbcb8 (0x020fbcb8, size 0x80) | lunavyqo (Grok) | 2026-07-23 | **active** — batch3 continue from div=21; API clm_d34ba21f0d09 (was 24); size-matched stack-zero ix seed; regperm residual; tip banked; API clm_36c9fdee6e56 released |
| ov002 func_ov002_020e7f2c (0x020e7f2c, size 0xa0) | lunavyqo (Grok) | 2026-07-23 | **active** — batch3 continue from div=8; API clm_b366b08e593e (was 18); Electrocute volatiles + u64-mask 0x494; size-matched; r1/r2 + arg-order residual; tip banked; API clm_76e13b83d8a5 released |
| ov006 func_ov006_020def80 (0x020def80, size 0xa4) | lunavyqo (Grok) | 2026-07-23 | **done** — verified byte-identical + linkcheck (mwccarm 1.2/sp2p3); near-miss CF + permuter new_var=i; API clm_077bc8125bbb kept (was 24); fixed always-zero 0x5440/44c epilogue; tip banked; API clm_6fb9697167b1 released |
| ov002 func_ov002_020e5948 (0x020e5948, size 0x9e8) | lunavyqo (Grok) | 2026-07-23 | **released** — improved near-miss **div=195** (was 523); loop-join+bool+reload; residual stack/regperm. Tip banked nearmiss/db.jsonl. API clm_93022a39b6a5 released |
| ov002 func_ov002_020bb520 (0x020bb520, size 0xf4) | lunavyqo (Grok) | 2026-07-23 | **released** — improved near-miss **div=6** (was 10); if/else bool materialize + ret pattern; residual mid-return uncond vs cond epilogue wall. Tip banked nearmiss/db.jsonl. API clm_26a90ec960dd released |
| ov062 func_ov062_02119af0 (0x02119af0, size 0xf0) | lunavyqo (Grok) | 2026-07-23 | **released** — no improvement (div=17); regperm + GetNode-index/CF tries. API clm_ce21e2c0b8c9 released |
| ov006 func_ov006_020cc8c8 (0x020cc8c8, size 0xf0) | lunavyqo (Grok) | 2026-07-23 | **released** — no improvement (div=32); size/zero-reg scheduling. API clm_be4e5dbe56fe released |
| ov063 func_ov063_02119960 (0x02119960, size 0xcc) | lunavyqo (Grok) | 2026-07-23 | **released** — no improvement (div=20); pool-offset 0x5d4 + Fix12 reg wall. API clm_c46538b71b84 released |
| ov006 func_ov006_021173c8 (0x021173c8, size 0x10c0) | lunavyqo (Grok) | 2026-07-23 | **released** — tip **div=15** (was 18/597); fn-scope pcnt/pcnt2/val fixes val@0x14; residual pcnt@0x2c vs ROM 0x10 (pcnt2 holds 0x10); floor(slot-order); API released |
| ov003 func_ov003_020af8a0 (0x020af8a0, size 0xc50) | lunavyqo (Grok) | 2026-07-23 | **released** — improved tip div 194→183 (star/char section); banked nearmiss/db.jsonl; regperm r5/r6 level/bitsPtr + pool-addr residual; API clm_1638a6207c04 released |
| ov006 func_ov006_020d27dc (0x020d27dc, size 0xe48) | lunavyqo (Grok) | 2026-07-23 | **released** — improved tip div 1054→432 banked in nearmiss/db.jsonl; size still 0xe20 vs 0xe48; API clm_bcb401fbaed7 released |
| ov006 batch4: func_ov006_020e8bd0 (0x020e8bd0, 0xa4), func_ov006_020deed8 (0x020deed8, 0xa8), func_ov006_0211dad0 (0x0211dad0, 0xac) | lunavyqo (Grok) | 2026-07-23 | **partial** — func_ov006_020e8bd0 MATCH+linkcheck VERIFIED; deed8/dad0 still open |
| ov007 func_ov007_020c3fe4 (0x020c3fe4, size 0xac) | lunavyqo (Grok) | 2026-07-23 | **active** — batch4 cont F4 regperm; re-locked API |
