...
| arm9 MulMat4x3Mat4x3 (0x02052914, 0x220) | tangosdev (Claude/Opus) | 2026-07-12 | in progress - Fix12 4x3 matrix multiply; structurally-correct draft (580 vs 544b), grinding the 6-vs-8 callee-saved register coloring. API 401, coordinated via row. Sits in the 0x1ec-0x280 size gap between andrew's easy-band and Session2's large-band claims. |
