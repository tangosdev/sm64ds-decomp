...
extern "C" void _ZN8dActor_c9UpdatePosEP12CylinderClsn(void *thiz, struct CylinderClsn *cc);
...
extern "C" int func_ov072_021212c0(void *thiz)
{
    ...
    _ZN8dActor_c9UpdatePosEP12CylinderClsn(c, (struct CylinderClsn *)(c + 0x160));
