...
extern "C" int func_ov100_02144730(char* self, char* arg1)
{
    ...
    if (_ZN9Animation8FinishedEv(self + 0x124) != 0) {
        ...
        *(s8*)(arg1 + 0xcc) = t;
        ChangeArea(t);
        {
            int* p = (int*)(((long long)(int)(*(char**)&CAMERA + 0x154)) & 0xFFFFFFFFFFFFFFFFLL);
            *p &= ~0xc00;
        }
        ...
        if (_ZNK9Animation12WillHitFrameEi(self + 0x124, (u16)(_ZNK9Animation13GetFrameCountEv(self + 0x124) - 0x1c)) != 0) {
            ...
            *p &= ~0xc00;
            if (*(int*)(self + 8) != 0xd) {
                _ZN5Sound13PlayCharVoiceEjjRK7Vector3(*(unsigned char*)(&SAVE_DATA + 0x41), 0x21, self + 0x74);
        ...
        if (_ZNK9Animation12WillHitFrameEi(self + 0x124, (u16)(_ZNK9Animation13GetFrameCountEv(self + 0x124) - 0x18)) != 0) {
            if (*(s8*)&NEXT_LEVEL_ID >= 0)
                *(int*)(self + 0x130) = 0;
            _ZN6Camera14GoBehindPlayerEj(*(char**)&CAMERA, CURR_PLAYER_ID);
        }
    }
    return 1;
}
