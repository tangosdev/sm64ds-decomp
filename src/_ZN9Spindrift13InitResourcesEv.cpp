...
/* Spell the ROM's own symbols. This file used local stand-in classes whose method
   calls mangled to names that exist nowhere -- _ZN18MovingCylinderClsn4InitEP5Actoriijj
...
extern "C" void _ZN18MovingCylinderClsn4InitEP5Actor5Fix12IiES3_jj(void *self, Actor *a, int r, int h, unsigned int d, unsigned int e);
extern "C" void _ZN12WithMeshClsn4InitEP5Actor5Fix12IiES3_P10Vector3_16S5_(void *self, Actor *a, int r, int h, void *v, void *w);
...
int Spindrift::InitResources()
{
    ...
    if (_ZN11ShadowModel12InitCylinderEv(s + 0x174) == 0)
        return 0;
    _ZN18MovingCylinderClsn4InitEP5Actor5Fix12IiES3_jj(s + 0x19c, ((Actor *)this), 0x3c000, 0x78000, 0x200000, 0xa6efe0);
    _ZN12WithMeshClsn4InitEP5Actor5Fix12IiES3_P10Vector3_16S5_(s + 0x1d0, ((Actor *)this), 0x3c000, 0x3c000, 0, 0);
