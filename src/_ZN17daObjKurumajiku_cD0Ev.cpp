 ...
 *
 * ~daObjKurumajiku_c is defined in the class body -- this class's two
 ...
 * the rest.
 *
 * A DELETE-EXPRESSION, NOT `p->~daObjKurumajiku_c()`, for the same reason
 ...
 * and brings it back.
 *
 * D0 is the deleting half: destroy through daObjKurumajiku_c and
 * dBgActor_c, then hand the object back through dActor_c's inline operator
 * delete, which is why nothing here mentions a heap.
 */
#include "daObjKurumajiku_c.h"

#ifdef _MSC_VER
/* THE HOST NEEDS THE ROM'S FLAT D0 NAME, AND MSVC NEVER EMITS IT. ~daObjKurumajiku_c()
...
extern "C" void _ZN17daObjKurumajiku_cD1Ev(void *self);
extern "C" daObjKurumajiku_c *_ZN17daObjKurumajiku_cD0Ev(daObjKurumajiku_c *thiz)
{
    _ZN17daObjKurumajiku_cD1Ev(thiz);          /* the D1 body, through its flat ROM name */
    daObjKurumajiku_c::operator delete(thiz);  /* the class-specific delete D0 ends with */
    return thiz;
}
#else
