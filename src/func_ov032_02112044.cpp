...
void func_ov032_02112044(char* c)
{
    ...
    *(M48*)(c + 0x368) = *(M48*)MATRIX_SCRATCH_PAPER;
    Matrix4x3_FromTranslation(MATRIX_SCRATCH_PAPER, *(int*)(c + 0x5c) >> 3, (*(int*)(c + 0x60) - 0x5a000) >> 3, *(int*)(c + 0x64) >> 3);
    *(M48*)(c + 0x3dc) = *(M48*)MATRIX_SCRATCH_PAPER;
