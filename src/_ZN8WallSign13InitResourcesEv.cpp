...
extern void _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(char* self, char* actor, const struct Vector3* pos, int a, unsigned int b, unsigned int c, unsigned int d);
}
...
int WallSign::InitResources()
{
  ...
  _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(((char*)this) + 0x320, ((char*)this), &v, 0x78000, 0x64000, 0x4800002, 0);
  return 1;
}
