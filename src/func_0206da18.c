...
// IRQ/CPSR control -- IRQ-disable (I bit, 0x80) toggle with dual entry points
...
extern void func_0206da30(void); // shared body label at +0x18 inside this function

asm int func_0206da18(void) {
    mov r0, #0
    b lbl
    mov r0, #1
    b lbl
lbl:
    ldr r1, =func_0206da30
    bx r1
    mrs r3, cpsr
    mov r1, r3
    and r1, r1, #0x80
