...
extern int _ZN10dBgCh_ActrD1Ev(void* c);
...
extern int _ZN10dCcAcPos_cD1Ev(void* c);
extern int _ZN9ModelAnimD1Ev(void* c);
extern int _ZN12dEnemyBase_cD2Ev(int* x);
...
int _ZN8GoombossD0Ev(struct Goomboss *self) {
    *(void**)((void*)self) = _ZTV8Goomboss;
    ...
    __destroy_arr((char*)((void*)self)+0x110, 4, 0x40, (void*)_ZN10dCcAcPos_cD1Ev);
    _ZN12dEnemyBase_cD2Ev((int*)((void*)self));
