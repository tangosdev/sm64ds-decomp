...
extern void _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(u32 id, u32 f, const Vector3 *v, const Vector3_16 *r, int a, int b);
    ...
    *((s32 *) (c + 0x44c)) = _ZN5Sound8PlayLongEjjjRK7Vector3s(*((s32 *) (c + 0x44c)), 3, *((s32 *) (c + 0x450)), (const Vector3 *) (c + 0x74), 0);
    ...
    if ((t % 5) == 0)
    {
      ...
      if ((r4 >= 0xf) && (r4 < 0x14))
      {
        ...
        u32 hi = ((u32) rnd) >> 16;
        u32 m = hi % 10u;
        _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0x118, (m << new_var) | 0x11, (Vector3 *) pos, (const Vector3_16 *) (c + 0x92), *((s8 *) (c + 0xcc)), -1);
      }
      else
      {
        s32 rnd = RandomIntInternal(&data_0209e650);
        u32 hi = ((u32) rnd) >> 16;
        u32 m = hi % 10u;
        _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0x118, (m << 10) | 1, (Vector3 *) pos, (const Vector3_16 *) (c + 0x92), *((s8 *) (c + 0xcc)), -1);
      }
    }
    {
