...
extern void _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(void* thiz, void* actor, void* pos, int r, int s, unsigned int a, unsigned int b);
extern void _ZN12WithMeshClsn4InitEP8dActor_c5Fix12IiES3_P10Vector3_16S5_(void* thiz, void* actor, int a, int b, void* v, void* w);
...
int Key::InitResources()
{
    ...
    if (mState == 7) {
        ...
        _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(((char*)this) + 0x220, ((char*)this), v, 0x50000, 0xfa000, 0x800003, 0x8000);
        _ZN12WithMeshClsn4InitEP8dActor_c5Fix12IiES3_P10Vector3_16S5_(((char*)this) + 0x260, ((char*)this), 0xa0000, 0, 0, 0);
        mSpinSpeed = 0x400;
        mVertAccel = 0;
        ...
        _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(((char*)this) + 0x220, ((char*)this), v2, 0x50000, 0x64000, 0x800003, 0x8000);
        _ZN12WithMeshClsn4InitEP8dActor_c5Fix12IiES3_P10Vector3_16S5_(((char*)this) + 0x260, ((char*)this), 0x48000, 0, 0, 0);
        mVertAccel = -0x2000;
        mSpinSpeed = 0;
    }
