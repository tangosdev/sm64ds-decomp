...
extern void _ZN10dBgW_KcMbg7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(char* thiz, void* kcl, char* mtx, int fix, short s, char* block);
...
int func_ov002_020b6c54(char* sb, char** arg, unsigned int actorID){
  ...
  m = _ZN7dBgW_Kc8LoadFileER13SharedFilePtr(arg[1]);
  _ZN10dBgW_KcMbg7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(sb+0x124, m, sb+0x2ec, 0x199, *(short*)(sb+0x8e), arg[2]);
  for(i = 0; i < 4; i++){
    char* sp;
