...
void func_ov091_02131cb0(void *c, const Vector3 *v0, const Vector3 *v1)
{
    ...
    *(s16*)((char*)c+0x92) = _ZN4cstd5atan2E5Fix12IiES1_(temp.y, Vec3_HorzLen(&temp));
    s32 r = (s32)(((long long)V98 * data_02082214[(A92>>4)*2+1] + 0x800) >> 12);
    *(s32*)((char*)c+0xa4) = (s32)(((long long)r * data_02082214[(A94>>4)*2] + 0x800) >> 12);
    *(s32*)((char*)c+0xa8) = (s32)(((long long)V98 * data_02082214[(A92>>4)*2] + 0x800) >> 12);
    *(s32*)((char*)c+0xac) = (s32)(((long long)r * data_02082214[(A94>>4)*2+1] + 0x800) >> 12);
}
