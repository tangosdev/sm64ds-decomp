...
extern int WM_SendCommand(int a, int b, int c, int d, int e, int f, int g,
                  ...
                  u16 arg6, int arg7, int arg8, int arg9, int arg10)
{
    ...
    base = WM_GetSystemWork();
    r = WM_CheckStateEx(2, 7, 8);
    if (r != 0)
        return r;
    ...
    if (arg4 & 0x1f)
        return 6;
    WM_SetCallbackTable(0xe, arg0);
    r = WM_SendCommand(0xe, 0xa, arg1, (unsigned int)arg2 >> 1,
