...
int _ZN6Player9StartTalkER7fBase_cb(void* self, fBase_c& a, bool b);
void _ZN5Sound17ChangeMusicVolumeEj5Fix12IiE(unsigned int a, int fix);
int _ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(void* self, fBase_c& a, unsigned int b, const Vector3* v, unsigned int d, unsigned int e);
...
extern "C" int func_ov078_02124cf4(unsigned char* thiz)
{
    ...
    *(int*)(thiz + 0x98) = 0;
    ...
    if (_ZN6Player9StartTalkER7fBase_cb(other, *(fBase_c*)thiz, 1) == 0) goto done;
    ...
    if (_ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(other, *(fBase_c*)thiz, (unsigned)(int)msg, (Vector3*)(thiz + 0x5c), 0, 0) == 0) goto done;
