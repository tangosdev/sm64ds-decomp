...
void __sinit_ov022_02112ec0(void)
{
    ...
    func_020731dc(data_ov022_021145d0, SharedFilePtr_Destruct_Clsn, data_ov022_021145f4);
    ...
    func_020731dc(data_ov022_021145c8, SharedFilePtr_Destruct_Clsn, data_ov022_0211460c);
}
