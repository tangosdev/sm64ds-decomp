//cpp
extern "C" {
extern unsigned int _ZN5Sound8PlayLongEjjjRK7Vector3s(unsigned int, unsigned int, unsigned int, void*, unsigned int);
...
int func_ov073_0211fbf4(char* c){
  ...
  *(unsigned int*)(c+0x500) = _ZN5Sound8PlayLongEjjjRK7Vector3s(*(unsigned int*)(c+0x500), 3, 0x170, c+0x74, 0);
  _ZN6Camera9SetFlag_3Ev(data_0209f318);
  func_ov073_0211f144(c);
  if(_ZN6Player12GetTalkStateEv(pl) == -1){
    ChiefChilly_ChangeState(c, data_ov073_02123370);
  }
  return 1;
}
}
