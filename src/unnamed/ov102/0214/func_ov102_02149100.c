...
extern char* _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, const Vector3* v, const Vector3_16* w, int e, int f);
...
void func_ov102_02149100(char *c, Vector3 *pos, int n, unsigned int speed, short arg5)
{
    ...
    do {
        a = _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0x120, 2, pos, 0, *(signed char*)(c+0xcc), -1);
        if (a != 0) {
            do {
