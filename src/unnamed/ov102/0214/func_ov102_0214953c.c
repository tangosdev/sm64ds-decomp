...
extern void* _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, Vector3* pos, void* r, int e, int f);
...
void func_ov102_0214953c(char* c, int p1, int p2)
{
    ...
    o = (char*)_ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(
