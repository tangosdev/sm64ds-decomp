...
void func_ov006_020cd9b0(char* self)
{
    ...
    if (!(data_ov006_02140834 & 1)) {
        ...
        func_020731dc((int)&data_ov006_021408c0, (int)&_ZN7Vector3D1Ev, (void**)&data_ov006_021408b4);
    ...
    if (!(data_ov006_0214083c & 1)) {
        ...
        func_020731dc((int)&data_ov006_021408e4, (int)&_ZN7Vector3D1Ev, (void**)&data_ov006_021408d8);
