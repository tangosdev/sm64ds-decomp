    ...
    extern char* _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, void* pos, void* rot, int e, int f);
        ...
        case 0:
            ...
            if (*(int*)(c + 0x5a0) < 5) {
                ...
                if (cb != 5 && (int)cb - *(int*)(c + 0x5a0) < 2) {
                    char* p = _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(
