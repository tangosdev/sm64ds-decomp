...
int _ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(void* self, void* actor, unsigned int msg, const Vector3* v, unsigned int a, unsigned int b);
...
extern "C" void func_ov062_0211a740(char* c)
{
    ...
    case 1:
            ...
            return;
        {
            ...
            if (_ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(*(void**)(c + 0x398), c, msg, &v, 1, 0) != 0)
                *(u8*)(c + 0x390) += 1;
        }
        return;
    case 2:
