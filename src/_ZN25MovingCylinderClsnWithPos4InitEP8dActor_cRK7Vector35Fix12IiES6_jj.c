...
extern void _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj(void* self, struct dActor_c* actor, Fix12i radius, Fix12i height, u32 flags, u32 vulnFlags);
...
void _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(
    ...
    u32 vulnFlags)
{
    _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj(self, actor, radius, height, flags, vulnFlags);
