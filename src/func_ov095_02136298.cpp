...
extern unsigned int _ZN5Sound8PlayLongEjjjRK7Vector3s(unsigned int a, unsigned int b, unsigned int d, const Vector3& v, unsigned int e);
extern void _Z14ApproachLinearRiii(int& x, int target, int step);

void func_ov095_02136298(char* c)
{
    *(unsigned int*)(c + 0x340) = _ZN5Sound8PlayLongEjjjRK7Vector3s(
