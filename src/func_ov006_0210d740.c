...
void* func_ov006_0210d740(char* c){
    *(void**)c = data_ov006_0213eefc;
    __destroy_arr(c + 0x599c, 0x40, 0x24, (void*)func_ov006_0210d894);
    __destroy_arr(c + 0x48d4, 0x10, 8, (void*)NullDestructor_0203d47c);
    __destroy_arr(c + 0x4854, 0x10, 8, (void*)NullDestructor_0203d47c);
    __destroy_arr(c + 0x47c8, 5, 8, (void*)NullDestructor_0203d47c);
