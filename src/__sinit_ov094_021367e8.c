...
void __sinit_ov094_021367e8(void)
{
    ...
    func_020731dc(&g_af8, SharedFilePtr_Destruct_Anim, &g_b24);
    _ZN13SharedFilePtr9ConstructEj(&g_ae8, 0x3cd);
    func_020731dc(&g_ae8, SharedFilePtr_Destruct_Anim, &g_b00);
    _ZN13SharedFilePtr9ConstructEj(&g_af0, 0x3ce);
    func_020731dc(&g_af0, SharedFilePtr_Destruct_Anim, &g_b0c);
