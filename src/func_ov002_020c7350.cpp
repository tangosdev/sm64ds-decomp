...
extern void *_ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, Vector3 *v, Vector3_16 *v2, int e, int f);
...
void func_ov002_020c7350(char *c)
{
...

    {
        ...
        if (st == 0x10 || st == 0x12) {
            ...
            actor = _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0x11a, *(s8 *)(c + 0x719), (Vector3 *)(c + 0x5c), (Vector3_16 *)(c + 0x8c), *(s8 *)(c + 0xcc), -1);
            if (*(int *)(c + 8) == 2) {
