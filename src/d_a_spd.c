...
/* Reconstructed source-style name: SM64DS proves daSpd_c through RTTI,
 * allocation size, vtable identity, and the SPIDER registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: Scuttlebug_Spawn. */
int *daSpd_c_classInit(void)
{
