//cpp
/* func_ov079_02126164 at 0x02126164 (ov079), size 0x424
 * Compiler mwccarm 1.2/sp2p3, flags:
 * -O4,p -enum int -lang c++ -char signed -interworking -proc arm946e -gccext,on -msgstyle gcc
 * branch condition inverted (!=0 with swapped arms): the scheduler's loads-before-stores
 * batching fires only when the store+call arm is the else block */
...
extern "C" int func_ov079_02126164(char *self) {
    u16 id;
    int r6;
    u8 idx;
    void *bmd;
