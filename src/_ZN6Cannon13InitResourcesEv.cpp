    ...
    *(u8*)(c + 0x185) = 0;
    ...
    if (k != 2) {
        ...
        *(int*)(c + 0x180) = 0;
        ...
        _ZN7dCcAc_c4InitEP8dActor_c5Fix12IiES3_jj(c + 0x124, ((void *)this), 0xa0000, 0x12c000, 0x800004, 0);
    } else {
        *(int*)(c + 0x60) -= 0x190000;
        ...
        *(int*)(c + 0x180) = 2;
        *(int*)(c + 0xb0) &= ~1;
        _ZN7dCcAc_c4InitEP8dActor_c5Fix12IiES3_jj(c + 0x124, ((void *)this), 0x50000, 0x12c000, 0x800004, 0);
    }
