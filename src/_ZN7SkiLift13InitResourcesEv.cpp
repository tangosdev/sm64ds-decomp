...
s32 SkiLift::InitResources() {
  ...
  _ZN10dBgW_KcMbg7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(c+0x124, kf, c+0x2ec, 0x1000, self->unk_08e, data_ov018_02112f48);
  func_020393d4((int*)(c+0x124), (int)_ZN4dBgW22UpdatePosWithTransformERS_P8dActor_cR10ClsnResultR7Vector3P10Vector3_16S8_);
