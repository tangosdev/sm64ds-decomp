...
extern Vector3 data_ov003_020b132c;
extern Vector3 data_ov003_020b1338;
extern Vector3 data_ov003_020b1344;
extern int data_020a0db0;
extern unsigned char data_0209caa0[];
extern void *_ZN3OAM7NUMBERSE[];
extern void *data_ov000_020ab938;
extern void *data_ov000_020ab940;
extern void *data_ov000_020abb18[];
extern void *data_ov000_020abd78;
extern void *data_ov000_020abd80;
extern void *data_ov000_020abb34;
extern void *data_ov000_020abb54;
extern void *data_ov000_020abb74;
extern void *data_ov000_020abb94;
extern void *data_ov000_020abcb4[];
extern void *data_ov000_020abbb4;
extern void *data_ov000_020abbf4;
    ...
    if (SublevelToLevel(data_02092110[0]) <= 0xE) {
        ...
        if ((int)c114 >= 1) {
            ...
            do {
                ...
                mod = (Model *)(sl + 0x64 + idx * 0x50);
                mod->mat4x3 = data_020a0e68;
                mod->Render((const Vector3 *)0);
                r7 += 1;
                r8 += 0x18000;
            } while (r7 <= (c114 = *(unsigned char *)(sl + 0x114)));
        }
            ...
            do {
                if ((*(unsigned char *)(sl + 0x131) >> sbi) & 1) {
                    if (sbi == *(unsigned char *)(sl + 0x115)) {
                        _ZN3OAM9RenderSubEP7OamAttrii(&data_ov000_020ab938, *(unsigned char *)(sl + sbi + 0x11A), starY);
                    } else {
                        _ZN3OAM9RenderSubEP7OamAttrii(&data_ov000_020ab940, *(unsigned char *)(sl + sbi + 0x11A), starY);
                    }
                }
                _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(zero, data_ov000_020abb18[sbi], *(unsigned char *)(sl + sbi + 0x11A), pal, neg, neg, (void *)zero);
                sbi += 1;
        ...
        if (*(unsigned char *)(sl + 0x135) != 0) {
            ...
            if (m133 == 0) {
                ...
                _ZN3OAM9RenderSubEP7OamAttrii(&data_ov000_020abd78, *(unsigned char *)(sl + i115 + 0x11A), 6);
            } else if (m133 == 1) {
                int aidx = func_ov003_020adf50(sl);
                char *p = sl + aidx;
                _ZN3OAM9RenderSubEP7OamAttrii(&data_ov000_020abd80, *(unsigned char *)(p + 0x124) - 0x24, *(unsigned char *)(p + 0x128) - 8);
            } else {
                _ZN3OAM9RenderSubEP7OamAttrii(&data_ov000_020abd80, 0x50, *(unsigned char *)(sl + 0x12B) + 8);
            }
        }
        ...
        case 0:
            _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, &data_ov000_020abb34, 0x80, *(unsigned char *)(sl + 0x12B), -1, -1,
                *(int *)(sl + 0x50), *(int *)(sl + 0x54), (unsigned short)*(short *)(sl + 0x110), -1);
            break;
        case 1:
            _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, &data_ov000_020abb54, 0x80, *(unsigned char *)(sl + 0x12B), -1, -1,
                *(int *)(sl + 0x50), *(int *)(sl + 0x54), (unsigned short)*(short *)(sl + 0x110), -1);
            break;
        case 2:
            _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, &data_ov000_020abb74, 0x80, *(unsigned char *)(sl + 0x12B), -1, -1,
                *(int *)(sl + 0x50), *(int *)(sl + 0x54), (unsigned short)*(short *)(sl + 0x110), -1);
            break;
        case 3: {
            int rot0, rot1, rot2, rot3, rot4, rot5, rot6;
            _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, &data_ov000_020abb94, 0x80, *(unsigned char *)(sl + 0x12B), -1, -1,
                *(int *)(sl + 0x50), *(int *)(sl + 0x54), (unsigned short)*(short *)(sl + 0x110), -1);
            r8 = 0;
            rot3 = r8;
            rot5 = r8;
            ...
            do {
                int slFlag = rot0;
                if (*(unsigned char *)(sl + 0x132) == r8 && *(unsigned char *)(sl + 0x118) != 0) {
                    slFlag = 3;
                }
                if (_ZN8SaveData19IsCharacterUnlockedEj(r8) != 0) {
                    if (*(unsigned char *)(sl + 0x139) == 2) {
                        if (r8 == func_ov003_020adf50(sl)) {
                            if (*(unsigned char *)(sl + 0x13A) == 0) {
                                char *sb1 = sl + r8;
                                _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, data_ov000_020abcb4[r8 + 3],
                                    *(unsigned char *)(sb1 + 0x124), *(unsigned char *)(sb1 + 0x128), -1, -1,
                                    *(int *)(sl + 0x58), *(int *)(sl + 0x5c), rot1, -1);
                                _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, data_ov000_020abcb4[*(unsigned char *)(sb1 + 0x12C)],
                                    *(unsigned char *)(sb1 + 0x124), *(unsigned char *)(sb1 + 0x128), -1, -1,
                                ...
                                char *p1 = sl + r8;
                                char *p2 = sl + (r8 ^ sel);
                                _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, data_ov000_020abcb4[*(unsigned char *)(p2 + 0x12C)],
                            ...
                            if (u60 != 0) {
                                ...
                                _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, data_ov000_020abcb4[r8 + 3],
                                    *(unsigned char *)(sb2 + 0x124), *(unsigned char *)(sb2 + 0x128), -1, -1,
                                    u60, u60, rot5, -1);
                                u60b = *(int *)(sl + 0x60);
                                _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(1, data_ov000_020abcb4[*(unsigned char *)(sb2 + 0x12C)],
                                    *(unsigned char *)(sb2 + 0x124), *(unsigned char *)(sb2 + 0x128), -1, -1,
                                    u60b, u60b, rot6, -1);
                            }
                        }
                        ...
                        char *sb3 = sl + r8;
                        _ZN3OAM9RenderSubEP7OamAttrii(data_ov000_020abcb4[r8 + 3], *(unsigned char *)(sb3 + 0x124), slFlag + *(unsigned char *)(sb3 + 0x128));
                        _ZN3OAM9RenderSubEP7OamAttrii(data_ov000_020abcb4[*(unsigned char *)(sb3 + 0x12C)], *(unsigned char *)(sb3 + 0x124), slFlag + *(unsigned char *)(sb3 + 0x128));
                    }
                }
                r8 += 1;
            } while (r8 < 3);
        ...
        if ((unsigned char)*(unsigned char *)(sl + 0x130) <= 1 || data_0209caa0[0x41] != 3) {
            if (SublevelToLevel(data_02092110[0]) <= 0xE) {
                _ZN3OAM9RenderSubEP7OamAttrii(&data_ov000_020abbb4, 0x80, (*(short *)(sl + 0x10A) >> 8) + 0xA0);
            } else {
                _ZN3OAM9RenderSubEP7OamAttrii(&data_ov000_020abbf4, 0x80, (*(short *)(sl + 0x10A) >> 8) + 0xA0);
            }
        }
    }
