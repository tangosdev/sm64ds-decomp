...
extern "C" {
extern void _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(ModelAnim* ma, BCA_File* bca, int a, int f, unsigned short j);
...
void func_ov077_02125b1c(char* c) {
  *(int*)(c + 0x9c) = -0x2000;
  *(int*)(c + 0xa0) = -0x3c000;
  _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj((ModelAnim*)(c + 0x124), (BCA_File*)data_ov077_02127c14[1], 0, 0x1000, 0);
  *(int*)(c + 0x180) = 0x1000;
