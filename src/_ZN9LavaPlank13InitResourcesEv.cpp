...
extern int _ZN4dBgW21UpdatePosWithVelocityERS_P8dActor_cR10ClsnResultR7Vector3P10Vector3_16S8_(void);
}
...
int LavaPlank::InitResources()
{
  ...
  func_020393d4(&mMeshCollider, &_ZN4dBgW21UpdatePosWithVelocityERS_P8dActor_cR10ClsnResultR7Vector3P10Vector3_16S8_);
  unk_320 = mPosY;
  unk_324 = mAngleX;
  return 1;
}
