...
/* daObjBk_Lift_c::Kill() at ov015 0x0211233c, 0x64 bytes -- vtable slot 31.
 *
 * ATTRIBUTED BY THE VTABLE, AND THE OLD COMMENT WAS WRONG TWICE. _ZTV14daObjBk_Lift_c
 ...
 * the caller passes them; argued in full in src/actors/dBgActor_c.cpp, which is
 * where _ZN10dBgActor_c4KillEv now lives -- the one-function file this used to
 * name was folded into that TU. */
