 ...
 * folds the Itanium destructor variants into the one ~FirePiranhaPlantBig() it
...
extern "C" FirePiranhaPlantBig *_ZN19FirePiranhaPlantBigD0Ev(FirePiranhaPlantBig *thiz)
{
    thiz->FirePiranhaPlantBig::~FirePiranhaPlantBig();  /* the D1 body, through the one host symbol */
    FirePiranhaPlantBig::operator delete(thiz);         /* the class-specific delete D0 ends with */
    return thiz;
}
#else
