...
void __sinit_ov016_021136ec(void)
{
    ...
    func_020731dc(&g_d20, SharedFilePtr_Destruct_Anim, &g_d64);
    _ZN13SharedFilePtr9ConstructEj(&g_d30, 0x3b7);
    func_020731dc(&g_d30, SharedFilePtr_Destruct_Anim, &g_d70);
    _ZN13SharedFilePtr9ConstructEj(&g_d28, 0x3b8);
    func_020731dc(&g_d28, SharedFilePtr_Destruct_Anim, &g_d40);
