...
int func_02068e4c(int a0, u16 *a1, int a2, int a3, u16 a4, int a5)
{
  ...
  volatile int fill_i;
  /* base1/base2 are byte pointers, not ints: every +0x1400/+0x1e18/+0x1404
     store below is add-high / small-offset on the cartridge (add r0,r7,#0x1e00 /
     strh r3,[r0,#0x18]), which mwcc only emits for pointer arithmetic. With
     int bases each offset is materialized from the literal pool and stored
     through a register index, 15 words longer. */
  char *base1;
  char *base2;
  int irq;
  ...
  base1 = (char *) ((a0 + 0x1f) & (~0x1f));
  base2 = (char *) (((int) base1 + 0x371f) & (~0x1f));
  irq = _ZN3IRQ7DisableEv();
  fill_i = 0;
  data_020a9db0 = (short) a5;
  data_020a9db4 = (int) base1;
  data_020a9db8 = base2;
  MultiStore_Int(fill_i, (int *) base1, 0x3700);
  fill_s = 0;
  MultiStore16(fill_s, base2, 0x1340);
  {
    int i = 0;
  ...
  CpuCopy8(a1, base2 + 0x1300, 0x16);
  *((u16 *) (base1 + 0x1400)) = 0x100;
  *((u16 *) (base1 + 0x1402)) = 8;
  *((u16 *) (base1 + 0x1e18)) = 0;
  *((u16 *) (base1 + 0x1e1a)) = 0;
  *((u16 *) (base1 + 0x1e2c)) = 1;
  *((char **) (base1 + 0x1404)) = base2;
  *((char **) (base1 + 0x1408)) = base2 + 0x400;
  {
    char *hdr = base1 + 0x1300;
    *((u16 *) (hdr + 0x14)) = 1;
    *((u16 *) (hdr + 0x12)) = 0;
    *((u16 *) (hdr + 6)) = (short) a2;
    *((u16 *) (hdr + 8)) = (short) a3;
