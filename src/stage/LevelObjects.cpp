//cpp
/* Translation unit, reconstructed and promoted -- ov002 / the level-object loader.
 *
 * CANONICAL. The ROM build compiles this file and takes all 17 functions from
 * this one object; the one-function sources that owned 0x020fe190..0x020fea4c
 * are gone. See notes/translation-unit-reconstruction-plan.md (the design),
