...
extern int _ZN10dBgActor_c21UpdateModelPosAndRotYEv(void *self);
extern int _ZN10dBgActor_c19UpdateClsnPosAndRotEv(void *self);
...
int func_ov022_0211149c(char *c) {
    ...
    func_020393d4(c+0x124, _ZN16MeshColliderBase16UpdatePosAndAngsERS_P8dActor_cR10ClsnResultR7Vector3P10Vector3_16S8_);
