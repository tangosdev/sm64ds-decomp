...
void func_ov080_02125460(char *c)
{
    ...
    if (mode >= 2 || *(unsigned short *)(c + 0x1b6) == 0)
        difAmb |= 0x7fff0000;
    *(u32 *)0x40004c0 = difAmb;
    *(u32 *)0x40004c4 = (*(struct Ov080Mat **)(c + 0x1a8))->speEmi;
    {
        struct Ov080Mat *m2 = *(struct Ov080Mat **)(c + 0x1a8);
        G3_TexImageParam(m2->texAddr, (m2->param.w >> 0x1a) & 7, 0, (m2->param.w >> 0x14) & 7,
                         (m2->param.w >> 0x17) & 7, 0, 0, (m2->param.w >> 0x1d) & 1);
    }
    {
        struct Ov080Mat *m3 = *(struct Ov080Mat **)(c + 0x1a8);
        G3_TexPlttBase(m3->pltAddr, (m3->param.w >> 0x1a) & 7);
    }
