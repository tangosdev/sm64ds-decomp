...
extern "C" void _ZN8dActor_c9SetRangesE5Fix12IiES1_S1_S1_(void *, int, int, int, int);
...
int func_ov002_020b7e1c(char* self) {
    ...
    if (*(int*)(self + 0xc8) == 0) {
        _ZN8dActor_c9SetRangesE5Fix12IiES1_S1_S1_((dActor_c*)self, 0x32000, 0x32000, 0x1000000, 0x1000000);
    }
