/* dActor_c::IsPlayerInRange(Fix12i posX, Fix12i posY, Fix12i posZ, s32 maxDist)
 ...
 *   0x02010ad8 = dActor_c::ClosestPlayer()
...
int _ZN8dActor_c15IsPlayerInRangeE5Fix12IiES1_S1_i(struct dActor_c *self, Fix12i posX, Fix12i posY, Fix12i posZ, int maxDist) {
    struct Vector3 pos;
    pos.x = posX;
    pos.y = posY;
    pos.z = posZ;
    struct dActor_c *closest = _ZN8dActor_c13ClosestPlayerEv();
