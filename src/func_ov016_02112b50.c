// NONMATCHING: case-2 angle regperm p322 r1 vs ROM r3 / base r3 vs r0 (div=10, size-exact 0x2cc). Particle/tail verified; pure regperm residual.
typedef short s16;
...
int func_ov016_02112b50(char *c)
{
  ...
  case 2: {
    ...
    s16 t = *p322;
    char *base = (char *)inline_fn((int)c + 0x300);
    s16 *p8c = (s16 *)inline_fn((unsigned int)c + 0x8c);
    *p322 = (s16)(t + 4);
    t = *p320;
    *p320 = (s16)(t + *(s16 *)(base + 0x22));
    t = *p8c;
    *p8c = (s16)(t + *(s16 *)(base + 0x20));
