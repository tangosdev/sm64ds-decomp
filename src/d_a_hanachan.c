...
void *daHanachan_c_classInit(void){
  ...
  if(c){
    ...
    *(int**)(c) = _ZTV7Wiggler;
    ...
    __cxa_vec_ctor(c+0x3cc, 5, 0xc, func_0203d384, _ZN7Vector3D1Ev);
    __cxa_vec_ctor(c+0x408, 5, 0xc, func_0203d384, _ZN7Vector3D1Ev);
    __cxa_vec_ctor(c+0x444, 5, 6, func_0203d73c, _ZN8Vector3sD1Ev);
    __cxa_vec_ctor(c+0x478, 5, 0x40, _ZN10dCcAcPos_cC1Ev, _ZN10dCcAcPos_cD1Ev);
    __cxa_vec_ctor(c+0x5b8, 5, 0x40, _ZN10dCcAcPos_cC1Ev, _ZN10dCcAcPos_cD1Ev);
