//cpp
/* Scene::SetFaders(FaderBrightness*) at 0x0202e1e0, 0x8c bytes.
 *
 ...
 *
 * WHAT THIS FILE USED TO SAY. It declared a local `struct Scene` with ten
 * invented virtuals named v00..v24, took its argument as `Scene *thiz`, and
 ...
 *     along, and Scene::SetAndStopColorFader confirms by loading a FaderColor
