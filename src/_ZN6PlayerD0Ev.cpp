 ...
 * `Player::~Player()` makes mwcc emit D0, D1 and D2 together, and
 * objisolate keeps the one this file is bound to by config/arm9/overlays/ov002/delinks.txt.
 * That is why this file carries the same definition as
 * src/_ZN6PlayerD1Ev.cpp -- it is not duplication, it is how
