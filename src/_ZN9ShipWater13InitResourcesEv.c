...
extern int data_ov017_02111a94[];
int _ZN9ShipWater13InitResourcesEv(char* c){
  ...
  _ZN18TextureTransformer7PrepareER8BMD_FileR8BTA_File(data_ov017_02111c88[1], data_ov017_02111a60);
  _ZN18TextureTransformer7SetFileER8BTA_Filei5Fix12IiEj((char*)c+0x320, data_ov017_02111a60, 0, 0x1000, 0);
  _ZN10dBgActor_c21UpdateModelPosAndRotYEv(c);
  _ZN10dBgActor_c19UpdateClsnPosAndRotEv(c);
  int k = _ZN7dBgW_Kc8LoadFileER13SharedFilePtr(_ZN18TiltingPlatformBfsD0Ev);
  _ZN10dBgW_KcMbg7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block((char*)c+0x124, k, (char*)c+0x2ec, 0x1000, *(short*)((char*)c+0x8e), (void*)data_ov017_02111a94);
