 ...
 * allocation size, vtable identity, and the BLK_SKINOKO_TAG registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: MegaMushroomBlockTag_Spawn. */
int *daObjBlockItemTag_c_classInit_BLK_SKINOKO_TAG(void)
{
