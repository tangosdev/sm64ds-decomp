...
/* Reconstructed source-style name: SM64DS proves daBDonketu_c through RTTI,
 * allocation size, vtable identity, and the BOSS_DONKETU registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: BigBully_Spawn. */
int *daBDonketu_c_classInit(void)
{
