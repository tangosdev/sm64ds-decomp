 ...
 * folds the Itanium destructor variants into the one ~Whirlpool() it
...
extern "C" Whirlpool *_ZN9WhirlpoolD0Ev(Whirlpool *thiz)
{
    thiz->Whirlpool::~Whirlpool();     /* the D1 body, through the one host symbol */
    Whirlpool::operator delete(thiz);  /* the class-specific delete D0 ends with */
    return thiz;
}
#else
Whirlpool::~Whirlpool()
