...
#ifdef _MSC_VER
/* THE HOST NEEDS THE ROM'S FLAT D0 NAME, AND MSVC NEVER EMITS IT. ~Dorrie()
...
extern "C" Dorrie *_ZN6DorrieD0Ev(Dorrie *thiz)
{
    _ZN6DorrieD1Ev(thiz);           /* the D1 body, through its flat ROM name */
    Dorrie::operator delete(thiz);  /* the class-specific delete D0 ends with */
    return thiz;
}
#else
