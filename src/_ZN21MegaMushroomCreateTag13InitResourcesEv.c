extern int _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj();
...
int _ZN21MegaMushroomCreateTag13InitResourcesEv(char* c){
    _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj((char*)c+0xd4, c, 0x12c000, 0x32000, 0x800002, 0x20);
