...
extern "C" int func_ov094_021359d8(void *thiz)
{
    ...
    if (*(unsigned short *)(c + 0x100) == 1) {
        _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(c + 0x30c, (&data_ov094_02136ae8)[1], 0, 0x1000, 0);
        *(int *)(c + 0x3f0) = 0x1000;
    }
    ...
    if (rider != 0 && func_ov002_020df7f4(rider) == 1) {
        *(unsigned short *)(c + 0x100) = 0xa;
        _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(c + 0x30c, (&data_ov094_02136af8)[1], 0, 0x1000, 0);
    }
