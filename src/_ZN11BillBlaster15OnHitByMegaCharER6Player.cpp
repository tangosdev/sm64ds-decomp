...
/* daObjBkKillerdai_c::OnHitByMegaChar - byte-matched vs the ROM at mwccarm 2004/b56 with strict relocs (tools/match.py, size from ov079 symbols.txt); the vtable-slot-guess marker it carried was stale.
