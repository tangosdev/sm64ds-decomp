 ...
 * allocation size, vtable identity, and the BOMB_SEESAW registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: SeesawBob_Spawn. */
int *daObjSeesaw_c_classInit_BOMB_SEESAW(void)
{
