...
extern "C" void _ZN4dBgW21UpdatePosWithVelocityERS_P8dActor_cR10ClsnResultR7Vector3P10Vector3_16S8_();
    ...
    *(unsigned short*)(((int)s + 0x354)) += 1;
    if (old != *(int*)(s + 0x320)) {
        *(short*)(s + 0x354) = 0;
        ...
        func_020393d4(s + 0x124, (void*)&_ZN4dBgW21UpdatePosWithVelocityERS_P8dActor_cR10ClsnResultR7Vector3P10Vector3_16S8_);
    }
