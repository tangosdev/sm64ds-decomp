 ...
 * still supplies field offsets/names (unk_08e is dActor_c's mAngleY,
 * unk_0cc is dActor_c's mAreaId) exactly as the pre-migration body used
 * them, since RockPillar.h itself only declares the class's own 0x320..
 * 0x327 span as opaque padding. */
extern "C" {
...
int RockPillar::InitResources()
{
    ...
    _ZN10dBgW_KcMbg7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(c+0x124, kcl, c+0x2ec, 0x199, self->unk_08e, data_ov016_02113cac);
    _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0x3b, 0, c+0x5c, 0, self->unk_0cc, -1);
    return 1;
}
