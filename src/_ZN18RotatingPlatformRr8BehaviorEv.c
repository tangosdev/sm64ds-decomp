...
int _ZN18RotatingPlatformRr8BehaviorEv(char* c) {
    s16 a = *(u16*)(c + 0x116) << 10;
    if (*(u8*)(c + 0x118) == 0) {
        int idx = ((u16)a >> 4) * 2;
        *(s16*)(c + 0x8e) = *(s16*)(c + 0x112) + (int)((((s64)data_02082214[idx] << 13) + 0x800) >> 12);
        *(s16*)(c + 0x8c) = *(s16*)(c + 0x110) + (int)((((s64)data_02082214[idx + 1] << 11) + 0x800) >> 12);
    } else {
        int idx = ((u16)a >> 4) * 2;
        *(s16*)(c + 0x8e) = *(s16*)(c + 0x112) - (int)((((s64)data_02082214[idx] << 13) + 0x800) >> 12);
        *(s16*)(c + 0x8c) = *(s16*)(c + 0x110) + (int)((((s64)data_02082214[idx + 1] << 11) + 0x800) >> 12);
