...
/* Signature deliberately copied from the local declaration above: the
   ...
   mwccarm passes differently at the call site, so declaring the true
   types breaks the byte match. See notes/mwccarm-codegen.md 6az. */
extern "C" void _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj(void *, dActor_c* a, Fix12i b, Fix12i c, unsigned int d, unsigned int e);
...
int KoopaFlag::InitResources()
{
    ...
    _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj((MovingCylinderClsn*)((char*)&mMovingCylinderClsn), (dActor_c*)((char*)this), 0x35555, 0x294000, 0x280000c, 0);
    unk_16e = 0xff;
    mVictoryTimer = 0;
    return 1;
}
