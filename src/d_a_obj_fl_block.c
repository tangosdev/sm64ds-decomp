...
/* resolved: VT = _ZTV15daObjFl_Block_c */
 ...
 * The project's daObjFl_Block_c implementation aliases remain unchanged.
 * Historical alias: FloatOnLavaPlatform_Spawn. */
int *daObjFl_Block_c_classInit(void)
{
    int *p = (int *)_ZN7fBase_cnwEj(808);
    if (p) { _ZN10dBgActor_cC2Ev(p); p[0] = (int)_ZTV15daObjFl_Block_c; }
    return p;
}
