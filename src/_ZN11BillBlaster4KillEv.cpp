 ...
 * `from:0x02128034 kind:load to:0x02126e58` -- while _ZTV8Platform's word at the
 * same slot (from:0x0210aeb4) relocates to 0x020ee55c, _ZN8Platform4KillEv. Two
 ...
 *
 * Same shape as Platform::Kill with this class's own constants: particle 0x8d
