...
extern void* _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(u32, u32, const Vector3*, const Vector3_16*, int, int);
...
void* func_0200e5fc(u32 idx) {
    ...
    res = _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0xbf, idx | (idx << 3) | (data_0209b270 << 6) | (flag << 8), (const Vector3*)0, (const Vector3_16*)0, -1, -1);
    if (res == 0) return res;
    pb = &data_0209b270;
