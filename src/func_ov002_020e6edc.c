...
extern void _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(char* self, struct dActor_c* a, const struct Vector3* pos, int r, u32 f1, u32 f2, u32 f3);
...
void func_ov002_020e6edc(char* c)
{
    ...
    *(int*)(c+0x43c) = 8;
    ...
    _ZN25MovingCylinderClsnWithPos4InitEP8dActor_cRK7Vector35Fix12IiES6_jj(c+0x110, (struct dActor_c*)c, &v, 0x64000, 0x96000, 1, 0);
    *(int*)(c+0x440) = 0xc;
    p = (u16*)(((int)c + 0x4a2));
    *p = (*p & ~1) | 1;
    *p |= 2;
