...
extern void _ZN8dActor_c11UntrackStarERa(struct dActor_c* self, signed char* r);
extern struct dActor_c* _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(u32 a, u32 b, const struct Vector3* pos, const void* v, int e, int f);
extern void _ZN8Particle6System9NewSimpleEj5Fix12IiES2_S2_(u32 a, int b, int c, int d);
extern void _ZN7fBase_c18MarkForDestructionEv(struct dActor_c* self);
extern void _ZN5Sound13PlayCharVoiceEjjRK7Vector3(u32 a, u32 b, const struct Vector3* pos);

void func_ov002_020edca4(char* self)
{
    struct Vector3 pos;
    struct dActor_c* spawned;
    int xv, zv, yv, sy;
