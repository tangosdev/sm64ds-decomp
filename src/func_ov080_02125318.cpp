...
void _ZN8dActor_c15GivePlayerCoinsER6Playerhj(void* self, void* player, unsigned char a, unsigned int b);
...
void func_ov080_02125318(char* self, void* player) {
    if (_ZN6Player15IsCollectingCapEv(player)) {
        _ZN8dActor_c15GivePlayerCoinsER6Playerhj(self, player, 5, 0);
    }
    Vector3 vec;
    Vector3 vec2;
    int x = *(int*)(self + 0x5c);
    ...
    _ZN8dActor_c10PoofDustAtERK7Vector3(self, vec2);
