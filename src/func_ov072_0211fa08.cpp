//cpp
extern "C" {
int _ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(int, void*, int, void*, int, int);
...
int func_ov072_0211fa08(char* c){
  ...
  case 0:
    if(_ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(*(int*)(c+0x390), c, 0xb0, v, 0, 0) == 0) break;
