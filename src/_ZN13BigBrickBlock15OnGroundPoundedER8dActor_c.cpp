 ...
 * the signature, `virtual int OnGroundPounded(dActor_c &other)`.
 *
 ...
 * `int`-returning override compiles to the same bytes as the ROM's stub,
...
int BigBrickBlock::OnGroundPounded(dActor_c &other)
{
