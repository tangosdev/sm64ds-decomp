 ...
 * allocation size, vtable identity, and the CT_MECHA01 registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: TtcRotatingCube_Spawn. */
int *daObjCtRotateBlock_c_classInit_CT_MECHA01(void)
{
