 ...
 * this class's own (include/Stump.h). Model::LoadFile, MeshCollider::LoadFile
 * and MovingMeshCollider::SetFile stay extern "C" under their exact ROM
...
int Stump::InitResources()
{
    ...
    UpdateClsnPosAndRot();
    void *k = _ZN12MeshCollider8LoadFileER13SharedFilePtr(data_ov091_0213564c);
