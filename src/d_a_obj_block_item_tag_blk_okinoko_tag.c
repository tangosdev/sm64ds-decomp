 ...
 * allocation size, vtable identity, and the BLK_OKINOKO_TAG registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: OneUpMushroomBlockTag_Spawn. */
int *daObjBlockItemTag_c_classInit_BLK_OKINOKO_TAG(void)
{
