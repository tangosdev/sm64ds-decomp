...
extern void *_ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(u32 id, u32 a, struct Vector3 *pos, void *rot, int e, int f);
...
void func_ov084_021296cc(char *c)
{
    if (*(u8 *)(c + 0x464) == 1) {
        ...
        b = (char *)_ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(
