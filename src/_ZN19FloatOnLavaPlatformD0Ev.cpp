 ...
 * folds the Itanium destructor variants into the one ~FloatOnLavaPlatform() it
...
extern "C" FloatOnLavaPlatform *_ZN19FloatOnLavaPlatformD0Ev(FloatOnLavaPlatform *thiz)
{
    thiz->FloatOnLavaPlatform::~FloatOnLavaPlatform();  /* the D1 body, through the one host symbol */
    FloatOnLavaPlatform::operator delete(thiz);         /* the class-specific delete D0 ends with */
    return thiz;
}
#else
