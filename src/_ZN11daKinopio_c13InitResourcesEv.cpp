 ...
 *
 * daKinopio_c's spawn-time setup, and most of it is unpacking his spawn parameter.
 *
 ...
 * data_ov085_0212f27c requires -- which is how one daKinopio_c says different things
