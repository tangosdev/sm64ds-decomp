 ...
 * allocation size, vtable identity, and the KM3_SEESAW registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: SeesawBsPlank_Spawn. */
int *daObjSeesaw_c_classInit_KM3_SEESAW(void)
{
