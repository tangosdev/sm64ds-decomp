 ...
 * b _ZN12dBgCh_SphCrrD0Ev`, which moves `this` from the dBgPi base at +0x10 back to
 ...
 * ROM's secondary table data_02099348 (0x0209934c, filled in
...
extern "C" dBgCh_SphCrr *_ZThn16_N12dBgCh_SphCrrD0Ev(dBgPi *thiz)
{
    return _ZN12dBgCh_SphCrrD0Ev((dBgCh_SphCrr *)((char *)thiz - 16));
}
#else
