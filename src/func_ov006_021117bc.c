    ...
    case 1:
        {
            ...
            vec[2] = -a;
            vec[3] = b;
            RenderOamBothScreens(data_ov006_02137674[0], *(int*)(self + 8) >> 12, *(int*)(self + 0xc) >> 12, -1, 1, vec);
            RenderOamBothScreens(data_ov006_02137674[1], *(int*)(self + 8) >> 12, (*(int*)(self + 0xc) >> 12) + 5, -1, 2, vec);
        }
        break;
    }
}
