...
void func_ov006_020bfec0(char* camera, void* worldPosition, short* screenPosition) {
    int viewPosition[3];
    ...
    screenPosition[1] = -((scaledY + (int)0xfffa0800) >> 0xc);
    ...
    screenPosition[0] = (scaledX + 0x7f800) >> 0xc;
}
}
