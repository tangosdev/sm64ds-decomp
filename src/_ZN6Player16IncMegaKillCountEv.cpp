...
extern void *_ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int id, unsigned int p, struct Vec3 *pos, void *rot, int a, int b);
}
...
void Player::IncMegaKillCount()
{
  ...
  ++(*((unsigned short *) (((int) ((char *)&mMegaKillCount)))));
  new_var3 = -1;
  st = ((char *)this);
  st = st + 0x600;
