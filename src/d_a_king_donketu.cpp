...
extern "C" void* daKing_Donketu_c_classInit(void)
{
    ...
    if (p) {
        ...
        *(void**)p = &_ZTV11ChiefChilly;
        ...
        __cxa_vec_ctor(p + 0x3e8, 8, 0xc, (void*)&func_0203d384, (void*)&_ZN7Vector3D1Ev);
        __cxa_vec_ctor(p + 0x448, 8, 0xc, (void*)&func_0203d384, (void*)&_ZN7Vector3D1Ev);
        __cxa_vec_ctor(p + 0x4d4, 2, 0xc, (void*)&func_0203d384, (void*)&_ZN7Vector3D1Ev);
    }
    return p;
}
