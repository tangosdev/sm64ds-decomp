...
#ifdef _MSC_VER
/* THE HOST NEEDS THE ROM'S FLAT D0 NAME, AND MSVC NEVER EMITS IT. ~PyramidLift()
...
extern "C" PyramidLift *_ZN11PyramidLiftD0Ev(PyramidLift *thiz)
{
    _ZN11PyramidLiftD1Ev(thiz);          /* the D1 body, through its flat ROM name */
    PyramidLift::operator delete(thiz);  /* the class-specific delete D0 ends with */
    return thiz;
}
#else
