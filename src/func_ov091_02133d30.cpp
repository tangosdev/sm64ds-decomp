...
void *_ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(u32 id, u32 unk, const void *pos, const void *rot, int a, int b);
...
extern "C" int func_ov091_02133d30(Self *self)
{
    ...
    if (self->type > 0x1e) {
        ...
        if (!(self->type & 1)) {
            spawned = _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0xe7, 1, &self->x, 0, self->f_cc, -1);
            if (spawned != 0) {
