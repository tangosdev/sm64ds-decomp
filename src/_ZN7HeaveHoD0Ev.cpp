 ...
 * folds the Itanium destructor variants into the one ~HeaveHo() it
...
extern "C" HeaveHo *_ZN7HeaveHoD0Ev(HeaveHo *thiz)
{
    thiz->HeaveHo::~HeaveHo();       /* the D1 body, through the one host symbol */
    HeaveHo::operator delete(thiz);  /* the class-specific delete D0 ends with */
    return thiz;
}
#else
HeaveHo::~HeaveHo()
