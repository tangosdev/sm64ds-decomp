 ...
 * func_020393d4/MeshColliderBase::UpdatePosWithTransform are this class's
...
int LavaSeesaw::InitResources()
{
    ...
    UpdateClsnPosAndRot();
    void *k = _ZN12MeshCollider8LoadFileER13SharedFilePtr(&data_ov022_021145a0);
    _ZN18MovingMeshCollider7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(
        &mMeshCollider, k, &mClsnMat, 0x1000, mAngleY, &data_ov064_0211bacc);
    func_020393d4(&mMeshCollider, (void *)&_ZN16MeshColliderBase22UpdatePosWithTransformERS_P8dActor_cR10ClsnResultR7Vector3P10Vector3_16S8_);
    mSwingStep = -0x10;
    return 1;
}
