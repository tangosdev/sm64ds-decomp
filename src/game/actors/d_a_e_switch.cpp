//cpp
/**
 * EnemySpawner and EnemySwitchTag -- the event-switch pair.
 *
 * Two classes that shared one translation unit in the cartridge, consolidated here.
 * A TU can hold more than one class, and the ROM says these two do.
 *
 ...
 *
 * deslop
 * Leftover: some helpers keep their mangled extern "C" spellings, and a few of
 ...
 *   which needs its own byte proof -- not done here.
 */
...
extern "C" {
/* data_020a0eac (the actor heap) comes from fBase_c.h via the includes
 * above, spelled identically there; no local copy. */
