...
extern "C" {
extern int _ZN13daObjDorifu_c16CleanupResourcesEP20daObjDorifuResources(
    u8 *self, struct Arg *arg);
extern struct Arg data_ov047_02112508;
extern int _ZN13daObjDorifu_c13InitResourcesEP20daObjDorifuResources(
    u8 *self, struct Arg *arg);
}
