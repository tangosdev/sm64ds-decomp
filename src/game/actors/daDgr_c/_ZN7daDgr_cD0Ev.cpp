 ...
 * `~daDgr_c()` is enough, because mwcc emits D2, D0 and D1 together and
 ...
 * include/BigBrickBlock.h's D0 already proved for a leaf two levels below
 * dActor_c through dBgActor_c -- which is why nothing below mentions a heap.
 */
#include "daDgr_c.h"
