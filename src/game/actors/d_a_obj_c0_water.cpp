 ...
 *   The ROM mangle is RK7Vector3 (const Vector3 &); a pointer argument is
 *   byte-identical, so the reference spelling is unprovable from this
 *   caller. SharedFilePtr.h has no fields: Prepare reads the BMD at
...
extern "C" {
/* Sound::PlayLong(u32, u32, u32, const Vector3 &, s16) -- Sound.h has no
 * PlayLong. The RK7Vector3 reference vs pointer is unprovable from this
 * caller's bytes. */
