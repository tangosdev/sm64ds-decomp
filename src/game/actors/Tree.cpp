 ...
 *
 * The default stock build compiles this file once, derives its eight exact text
 * contributions, and substitutes them for the retained one-function comparison
 * objects. The manifest's partial-link proof and the ordinary ROM build both
 * require the linked module and final ROM to remain byte-identical.
 *
...
void* _ZN4TreeD0Ev(char* c){
  *(int*)c = (int)_ZTV4Tree;
  __cxa_vec_cleanup(c+0xd4, 5, 0x50, (void*)_ZN5ModelD1Ev);
  _ZN8dActor_cD2Ev(c);
...
int _ZN4TreeD1Ev(char* c){
    *(void**)c = (void*)_ZTV4Tree;
    __cxa_vec_cleanup((char*)c+0xd4, 5, 0x50, (void*)_ZN5ModelD1Ev);
    _ZN8dActor_cD2Ev(c);
    return (int)c;
}
}
