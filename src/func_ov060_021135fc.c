...
void func_ov060_021135fc(char *c)
{
    ...
    *(int*)(int)(c+0x378) |= 1;
    ...
    if (*(unsigned char*)(c+0x414) == 2) {
        ...
        pos.z = *(int*)(c+0x64);
        pos.y = pos.y + 0xa0000;
        _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(0x11b, 7, &pos, 0, *(signed char*)(c+0xcc), -1);
    } else {
        ...
        void *spawned = _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(0x11a, *(unsigned char*)(c+0x414), (Vector3*)(c+0x5c), 0, *(signed char*)(c+0xcc), -1);
