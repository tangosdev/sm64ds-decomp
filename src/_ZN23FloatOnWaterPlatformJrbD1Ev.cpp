 ...
 *
 * THREE vtable stores, and the middle one is the finding. `struct FloatOnWaterPlatformJrb :
 * daObjFloatBoard_c : Platform` emits its own vptr, then daObjFloatBoard_c's --
