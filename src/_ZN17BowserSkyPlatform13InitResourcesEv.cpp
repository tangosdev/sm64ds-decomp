...
/* daKpa3Bg_c::InitResources - name recovered from the vtable slot it fills.
   ...
   inferred stub. Model, ModelBase, MeshCollider, MovingMeshCollider and
   MeshColliderBase are the real classes, pulled in transitively through
    ...
    *(unsigned char*)(self + 0x329) = (unsigned char)idx;
    ...
    this->UpdateClsnPosAndRot();
    {
        ...
        _ZN18MovingMeshCollider7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(
            self + 0x124, (KCL_File*)MeshCollider::LoadFile(*data_ov060_0211953c[i]),
