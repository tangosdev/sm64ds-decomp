//cpp
/* Translation unit, reconstructed and promoted -- arm9 / fBase_c (Nintendo's fBase_c), the ROOT of
 * the actor hierarchy.
 *
 * CANONICAL. The ROM build compiles this file and takes all 24 functions from
 * this one object; the one-function sources that owned 0x02043444..0x02043dec
 * are gone. See notes/translation-unit-reconstruction-plan.md and notes/tu-
 * reconstruction-pilot-report.md.
 *
