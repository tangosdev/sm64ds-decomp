//cpp
/* ov002 / daSCoin_c -- the hidden "secret" coin (registry profile
 * g_profile_SECRET_COIN, RTTI name _ZTS9daSCoin_c at ov002:0x0210aff4).
 *
...
/* -------------------------------------------------------------------------- */
/* g_profile_SECRET_COIN, 0x0210b00c, size 0x1c                           */
/* -------------------------------------------------------------------------- */
/* The registry descriptor, on the reconstructed g_profile_<ROM ID> spelling
 * (literal ROM ID SECRET_COIN); the class it names is ROM-proven daSCoin_c
 * (_ZTS9daSCoin_c). */
