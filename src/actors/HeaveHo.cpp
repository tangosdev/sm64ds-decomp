 ...
 * return the object to its heap. Declaring `~HeaveHo()` is enough -- mwcc emits D1 and
 * D0 together from the inline body in the header, and objisolate keeps the one
