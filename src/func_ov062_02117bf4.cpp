...
void* _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, const Vector3& pos, const void* d, int e, int f);
}
...
extern "C" void func_ov062_02117bf4(char* c){
    ...
    *(int*)(c+0x98) = 0x14000;
    func_ov062_02117994(c, 7);
    {
        ...
        v.y = zz;
        v.z = yy;
        _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(0x11d, *(unsigned int*)(c+0x394), v, 0, *(signed char*)(c+0xcc), -1);
    }
    *(short*)(c+0x3ca) = 0xa;
