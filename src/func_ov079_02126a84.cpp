 ...
 * equal-arm ternary on the pointer arg (id ? c+0x74 : c+0x74) flips call-arg emission
 * order to const-first; the identical arms fold to a single add */
...
extern "C" int func_ov079_02126a84(char *c)
{
    ...
    if (id != 0) {
        ...
        if (flags & 0x10) {
            ...
            func_02012694(0x78, id ? c + 0x74 : c + 0x74);
        } else if (flags & 0x3c0) {
            *(int *)(c + 0x3d4) = 1;
            {
