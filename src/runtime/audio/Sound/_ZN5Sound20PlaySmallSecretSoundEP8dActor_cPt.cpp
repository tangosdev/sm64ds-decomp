//cpp
// @symbol _ZN5Sound20PlaySmallSecretSoundEP8dActor_cPt
//
...
//
// Sound::PlaySmallSecretSound(dActor_c*, u16*). Soft "small secret" chime while
// *counter < 0x19, then the full sound once the counter is saturated. dActor_c is
