...
void func_ov004_020b6430(void) {
    ...
    if (data_ov004_020bf9ec == 0 && data_ov004_020bfa18 != 0) {
        if (data_020a0db0 & 0x10) {
            Hud_RenderSprite((void*)data_ov004_020bc828[func_ov004_020ad674()][0], 0x14, 0x30, -1, -1);
        } else {
            Hud_RenderSprite((void*)data_ov004_020bc828[func_ov004_020ad674()][1], 0x14, 0x30, -1, -1);
        }
        Hud_RenderSprite((void*)data_ov004_020bc828[func_ov004_020ad674()][2], 0x14, 0x30, -1, -1);
    }
