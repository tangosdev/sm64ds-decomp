...
/* By-address propagation from the decomp's main: main spells 0x02013ee8
   _ZN7dBase_c5SpawnEjP7fBase_cii, this line still names that same address
   _ZN12ActorDerived5SpawnEjP9ActorBaseii (config/arm9/symbols.txt:462). Same
   function, older name -- the rename has not crossed to this branch. Spelling
   main's name here leaves the reloc unresolvable (linkcheck BLIND-1) and the
   host link short one external. */
