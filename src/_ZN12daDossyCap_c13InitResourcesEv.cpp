...
extern void _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj(void *clsn, void *actor, int a, int b, unsigned int c, unsigned int d);
}
struct G { int w[2]; };
...
int daDossyCap_c::InitResources()
{
    ...
    _ZN18MovingCylinderClsn4InitEP8dActor_c5Fix12IiES3_jj(((char *)this) + 0x140, ((char *)this), 0x96000, 0x96000, 0x100002, 0x8000);
    unk_174 = 0;
    return 1;
}
