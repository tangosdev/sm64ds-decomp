...
int _ZN6Player16St_BackFlip_InitEv(void* c) {
  *(char*)((char*)c+0x71b)=0;
  ...
  *(char*)((char*)c+0x6de)=1;
  *(char*)((char*)c+0x6df)=0;
  _ZN6Player7SetAnimEji5Fix12IiEj(c, 0x2a, 0x40000000, 0x1000, 0);
  *(int*)((char*)c+0xa8)=0x3e000;
  if (*(int*)((char*)c+8)==1) *(int*)((char*)c+0xa8)=0x4c000;
  func_ov002_020e2ad0(c);
  *(int*)((char*)c+0x98)=0x10000;
  *(short*)((char*)c+0x94) = *(short*)((char*)c+0x8e) + 0x8000;
