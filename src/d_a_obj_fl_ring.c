...
extern int _ZTV14daObjFl_Ring_c[];
 ...
 * The project's daObjFl_Ring_c implementation aliases remain unchanged.
 * Historical alias: VolcanoRing_Spawn. */
int *daObjFl_Ring_c_classInit(void)
{
    int *p = (int *)_ZN7fBase_cnwEj(808);
    if (p) { _ZN10dBgActor_cC2Ev(p); p[0] = (int)_ZTV14daObjFl_Ring_c; }
    return p;
}
