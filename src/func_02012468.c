// Creates/registers an entry via Sound_PlayIfNotActive(a,b,c,h), looks it up in the
// data_0209b53c table via func_02011934, and if found forwards (d,e,f,g) to
// func_02012860 on the entry's +8 sub-object. Returns the id from Sound_PlayIfNotActive.
