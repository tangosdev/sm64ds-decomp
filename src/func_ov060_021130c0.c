...
extern int _ZN6Player9StartTalkER7fBase_cb(void* player, void* actorBase, int isTalk);
...
extern int _ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(void* player, void* actorBase, unsigned int msgId, const void* pos, unsigned int a, unsigned int b);
