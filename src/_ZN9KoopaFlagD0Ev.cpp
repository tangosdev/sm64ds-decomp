...
#ifdef _MSC_VER
/* THE HOST NEEDS THE ROM'S FLAT D0 NAME, AND MSVC NEVER EMITS IT. ~KoopaFlag()
...
extern "C" KoopaFlag *_ZN9KoopaFlagD0Ev(KoopaFlag *thiz)
{
    thiz->KoopaFlag::~KoopaFlag();     /* the D1 body, expanded in place */
    KoopaFlag::operator delete(thiz);  /* the class-specific delete D0 ends with */
    return thiz;
}
#else
