...
void _ZN8dActor_c9SetRangesE5Fix12IiES1_S1_S1_(void *thiz, int a, int b, int c, int d);
...
int func_ov072_0211fb7c(char *c) {
    ...
    *(int*)(c + 0x154) = *(int*)(c + 0x398) << 1;
    ...
    _ZN8dActor_c9SetRangesE5Fix12IiES1_S1_S1_(c, *(int*)(c + 0x398), *(int*)(c + 0x398), 0x1000000, 0x1000000);
    p = (int*)(((int)c + 0xb0));
    *p = *p | 1;
    *(int*)(c + 0x394) = 0;
    return 1;
