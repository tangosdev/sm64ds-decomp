...
extern int _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(int, int, char *, int, int, int);
        ...
        *(int *)(c + 0x628) = _ZN8Particle6System3NewEjj5Fix12IiES2_S2_PK11Vector3_16fPNS_8CallbackE(
        ...
        if (*(u8 *)(c + 0x70a) == 0x10) {
            ...
            *(int *)(c + 0x688) = 0x187;
            ...
            st = _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0xb2, 0x6f, c + 0x5c,
                                                              (int)(c + 0x8c),
                                                              *(s8 *)(c + 0xcc), -1);
            if (st != 0)
