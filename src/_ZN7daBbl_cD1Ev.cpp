//cpp
// @symbol _ZN7daBbl_cD1Ev
/* recovered: real C++ destructor -- the compiler emits the whole body
 *
 * One vtable store and 3 destructor calls, every one a consequence of
 * `struct daBbl_c : dEnemyBase_c` and the members that declaration now types:
 ...
 * named those offsets in the first place, and `daBbl_c_classInit` constructs the
