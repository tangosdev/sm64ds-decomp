 ...
 *
 * Two of the three calls are Platform's own non-virtual members, so they are
 ...
 * IsClsnInRange stays a mangled extern because include/Platform.h does not
 * declare it and that header belongs to the whole Platform family, not to this
...
extern "C" int _ZN8Platform13IsClsnInRangeE5Fix12IiES1_(void *thiz, int x, int z);
