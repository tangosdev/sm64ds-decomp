 ...
 *
 * Then: spend the countdown at unk_094 and, once a second, replay the jingle
 * selected by unk_098; age the eight per-line timers in unk_06c; scan the
 ...
 * cell's angle in unk_03c up to its 0x8000 stop.
 *
 * The nine cell bytes are reached as (&unk_031)[k] -- the array begins at the
 * BASE's unk_031 and runs into this class's unk_034[6], so no member can name
