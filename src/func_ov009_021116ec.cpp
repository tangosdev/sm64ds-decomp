...
extern int _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, const Vector3* pos, const Vector3_16* rot, int e, int f);
    ...
    if (*(unsigned char*)(c + 0x180)) {
        ...
        if (n > 1) {
            ...
            for (int i = 0; i < n - 1; i++) {
                ...
                void* a = (void*)_ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(0x157, 0, &pos, &rot, (int)*(signed char*)(c + 0xcc), -1);
