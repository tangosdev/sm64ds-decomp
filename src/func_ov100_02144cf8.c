...
extern int _ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(void* thisp, void* actor, unsigned int msg, void* vec, unsigned int e, unsigned int two);
    ...
    if (func_ov100_021452e4(a, b)) {
        ...
        if (entry[8] >= 0) {
            ...
            if (NumStars() < entry[8]) {
                ...
                if (_ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(b, a, *(short*)(entry + 0xc), a + 0xa4, 0, 2) == 0) goto L240;
            ...
            if (func_ov100_02144f84() == 0) return 1;
            {
                ...
                if (_ZN6Player11ShowMessageER7fBase_cjPK7Vector3hh(b, a, (short)msg, a + 0xa4, 0, 2) == 0) goto L240;
            }
            func_ov100_021453d8(a, data_ov100_021488c4, b);
            if (entry[9] == 5)
