...
extern int _ZN8dActor_c9UpdatePosEP12CylinderClsn(char *t, char *c);
extern int WithMeshClsn_UpdateDiscreteNoLava_veneer(char *a);
...
int func_ov071_0211f694(char *t)
{
    *(short *)(t + 0x8c) = *(short *)(t + 0x8c) - 0x1000;
    ...
    _ZN8dActor_c9UpdatePosEP12CylinderClsn(t, t + 0x160);
    WithMeshClsn_UpdateDiscreteNoLava_veneer(t + 0x194);
