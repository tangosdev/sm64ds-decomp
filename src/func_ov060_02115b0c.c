...
extern void* _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, struct Vector3* pos, void* rot, int e, int f);
...
void func_ov060_02115b0c(char* c)
{
    ...
    _ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16as(0x119, 0, (struct Vector3*)(c + 0x5c), 0, *(signed char*)(c + 0xcc), -1);
}
