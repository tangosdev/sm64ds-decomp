 ...
 * `struct daObjPushblock_c : dBgActor_c` and the one member daObjPushblock_c itself adds:
 * its own vptr, then this class's own dBgCh_Actr at 0x320 -- the only field
 * daObjPushblock_c declares -- then dBgActor_c's vptr, inlined because dBgActor_c's
 ...
 * `_ZTV16daObjPushblock_c; dBgCh_Actr::D1(+0x320); _ZTV10dBgActor_c;
 * dBgW_KcMbg::D1(+0x124); Model::D1(+0xd4); dActor_c::D2` exactly.
 */
#include "daObjPushblock_c.h"

daObjPushblock_c::~daObjPushblock_c()
{
}
