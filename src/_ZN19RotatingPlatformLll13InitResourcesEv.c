...
int _ZN19RotatingPlatformLll13InitResourcesEv(char* c) {
  void* mdl;
  void* kcl;
  ...
  _ZN18MovingMeshCollider7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(c+0x124, kcl, c+0x2ec, 0x199, *(short*)(c+0x8e), data_ov064_0211bb0c);
  func_020393d4(c+0x124, &_ZN16MeshColliderBase21UpdatePosWithVelocityERS_P5ActorR10ClsnResultR7Vector3P10Vector3_16S8_);
  func_020393c4(c+0x124, &func_ov022_0211193c);
