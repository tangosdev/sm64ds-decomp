...
void func_ov006_020c9d7c(char *c)
{
    ...
    *(int*)(c + 0x28) = 0x100000;
    *(int*)(c + 0x24) = (int)((((unsigned int)(RandomIntInternal(&RNG_STATE) & 0x7fffffff) >> 19) - 0x800) * 0xc0);
    *(int*)(c + 0x40) = 0;
    int t = data_ov006_021405a4;
    int rv = (int)((((unsigned int)(RandomIntInternal(&RNG_STATE) & 0x7fffffff) >> 19) - 0x800) << 1);
