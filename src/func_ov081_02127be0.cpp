...
struct dActor_c {
    static dActor_c* Spawn(unsigned int a, unsigned int b, const Vector3& v, const Vector3_16_local* v16, signed char e, short f);
};
/* Signature deliberately copied from the local declaration above: the
   ROM name carries by-value class parameters (e.g. Fix12<int>), which
   mwccarm passes differently at the call site, so declaring the true
   types breaks the byte match. See notes/mwccarm-codegen.md 6az. */
extern "C" dActor_c* _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(unsigned int a, unsigned int b, const Vector3& v, const Vector3_16_local* v16, int e, int f);
...
extern "C" void func_ov081_02127be0(char* c)
{
    ...
    _ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0xb4, newflags, pos, &rot, *(signed char*)(c + 0xcc), -1);
    *(char**)(c + 0x364) = (char*)_ZN8dActor_c5SpawnEjjRK7Vector3PK10Vector3_16as(0xb2, newflags, pos, &rot, *(signed char*)(c + 0xcc), -1);
