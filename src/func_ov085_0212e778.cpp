...
void func_ov085_0212e778(char* c)
{
    ...
    *(M48*)(c + 0x12c) = *(M48*)MATRIX_SCRATCH_PAPER;
    Matrix4x3_FromTranslation(MATRIX_SCRATCH_PAPER, *(int*)(c + 0x5c) >> 3, (*(int*)(c + 0x60) - 0x38000) >> 3, *(int*)(c + 0x64) >> 3);
    *(M48*)(c + 0x240) = *(M48*)MATRIX_SCRATCH_PAPER;
