extern void __destroy_arr(void *p, int a, int b, void *fn);
extern void _ZN8Particle10SysTrackerD1Ev(void *p);
extern void _ZN11dScMgBase_cD2Ev(void *p);
...
void *func_ov006_021225ac(void *thiz)
{
    ...
    *(void **)c = data_ov006_0213fc7c;
    __destroy_arr(c + 0x7ad0, 5, 0x24, (void *)func_ov006_02120938);
    __destroy_arr(c + 0x7164, 0x14, 0x78, (void *)func_ov006_02122c68);
    __destroy_arr(c + 0x6ffc, 0xa, 0x24, (void *)func_ov006_020eed64);
    __destroy_arr(c + 0x5ddc, 0xa, 0x1d0, (void *)func_ov006_021227c8);
    __destroy_arr(c + 0x5458, 3, 0x32c, (void *)func_ov006_020d1008);
    __destroy_arr(c + 0x500c, 5, 0xdc, (void *)func_ov006_020ca604);
