//cpp
/* dActor_c::OnAimedAtWithEggReturnVec() at 0x020100dc, 0x48 bytes -- vtable slot 30.
 *
 ...
 * 0x74/4 = 29 falls out of include/dActor_c.h's declaration order.
 *
 * IT RETURNS A Vector3 BY VALUE, and include/dActor_c.h now says so -- it said
 ...
 * pointer-taking form stays, exactly as dActor_c's destructors stay extern "C"
 ...
 * real dActor_c and the real Vector3. The cast was measured both ways and is NOT
