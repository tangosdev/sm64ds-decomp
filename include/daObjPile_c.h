 ...
 *
 *   daObjPile_c_classInit  fBase_c::operator new(816 = 0x330),
 *                 dBgActor_c::dBgActor_c(), stores _ZTV11daObjPile_c,
 *                 then the members below in this order.
 *   ~daObjPile_c  the same members destroyed in reverse, then ~dBgActor_c.
 *
