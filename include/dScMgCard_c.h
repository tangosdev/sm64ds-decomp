...
struct dScMgCard_c : dScMgSingle3DBase_c {
    ...
    /* slot 21 -- the base does not declare slots 21-35 yet, so this stays a
       plain member occupying its slot; it becomes an override the day
       dScMgBase_c.h declares it. */
    int OnGroundPounded();            /* slot 21 -- ov006 0x020db6ec */
