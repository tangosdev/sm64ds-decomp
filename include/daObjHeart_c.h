 ...
 * class daObjHeart_c: 5 matched functions, 9 evidenced fields.
...
struct daObjHeart_c : dActor_c {
    ...
    /* Seeded 0x1000 (1.0) in InitResources; Behavior eases it toward 0x8000
       ...
       [_ZN12daObjHeart_c13InitResourcesEv.cpp,
        _ZN12daObjHeart_c8BehaviorEv.cpp] */
    ...
    /* Inline and declared FIRST: this TU defines every virtual, so it emits the
       vtable and RTTI itself. An out-of-line destructor here is the key function
       and makes mwcc emit D0 before D1, which is the reverse of the ROM's order,
       and it leaves a homeless D2 behind that objisolate refuses. */
