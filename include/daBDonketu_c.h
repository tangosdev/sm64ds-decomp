...
/* daBDonketu_c in the ROM's RTTI, and daDonketu_c's sibling rather than its subclass: both
...
typedef char daBDonketu_c_size_must_be_0x400[sizeof(daBDonketu_c) == 0x400 ? 1 : -1];
#endif

#endif /* DABDONKETU_C_H */
