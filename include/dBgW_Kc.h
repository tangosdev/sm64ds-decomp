...
struct dBgW_Kc : dBgW {
    ...
    /* DECLARED, never defined as a method here -- src/game/actors/dBgW_Kc/_ZN7dBgW_KcC1Ev.cpp
       owns C1 and src/game/actors/dBgW_Kc/_ZN7dBgW_KcC2Ev.c the base-subobject variant
