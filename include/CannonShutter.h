#ifndef CANNONSHUTTER_H
#define CANNONSHUTTER_H
...
struct CannonShutter : dBgActor_c {
    u8  pad_31e[0x2];
    s32 unk_320;                      /* 0x320 */
    s32 unk_324;                      /* 0x324 */
    s32 unk_328;                      /* 0x328 */
...
typedef char CannonShutter_size_must_be_0x330[sizeof(CannonShutter) == 0x330 ? 1 : -1];
...
struct CannonShutter {
    ...
    /* dBgW_KcMbg member, named by the class's own destructor calling
       ...
       checks. Was a u8 marker. [_ZN13CannonShutterD1Ev.c] */
