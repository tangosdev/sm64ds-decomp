 ...
 *   2  daTor_c::State2 -- winding down. Shrinks over 0x3c frames,
...
/* BASE: dActor_c, direct. _ZTI7daTor_c at ov096 0x02137a60 reads
 * [__si_class_type_info, _ZTS7daTor_c (0x02137a54), _ZTI8dActor_c], and the
 * vtable at 0x02137a90 carries that _ZTI at its address point minus 4. The
 * vtable has exactly the 31 dActor_c slots; daTor_c overrides 0/3/6/9 and
 * the destructor pair 16/17. The tree previously called the class Tornado
 * (coined). */
struct daTor_c : dActor_c {
    ...
    /* The actor that hit this tornado. Set from mdCcAc_c.otherOwner once
       func_ov002_020de33c approves it; daTor_c::State2 clears it as
    ...
    /* Out of line in daTor_c.cpp: the key function, so that TU emits
     * _ZTV/_ZTI/_ZTS7daTor_c. */
    virtual ~daTor_c();
     ...
     * implicit-this call shape and exclusive access to daTor_c state. */
