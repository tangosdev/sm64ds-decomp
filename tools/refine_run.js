...
For the full catalogue read notes/matching-style.md and notes/mwccarm-codegen.md - START WITH THE NEWEST SECTIONS 6aa/6ab/6ac (6aa: the pragma crutch ROTATES coloring, remove it and respell naturally; 6ab: dropped call arguments masquerade as regperm, equal-bytes shift respells rerank webs; 6ac: launder position in the address tree, stack-array escape aliasing, C89 top decls re-rank the callee-saved list), then 6e-6z for the older levers.
