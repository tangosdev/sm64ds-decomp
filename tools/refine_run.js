...
For the condensed rules read notes/matching-style.md and notes/codegen-rules.md. For the dated log start with the NEWEST SECTIONS 6aa/6ab/6ac in notes/mwccarm-codegen.md (6aa: the pragma crutch ROTATES coloring, remove it and respell naturally; 6ab: dropped call arguments masquerade as regperm, equal-bytes shift respells rerank webs; 6ac: launder position in the address tree, stack-array escape aliasing, C89 top decls re-rank the callee-saved list), then 6e-6z in the same file for the older levers.
