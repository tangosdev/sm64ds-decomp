...
CLI:
  python tools/agentlock.py acquire --files src/game/actors/Actor.cpp include/dActor_c.h --note "migrating Actor" [--ttl 1800] [--wait 60]
  ...
  python tools/agentlock.py renew   --files src/game/actors/Actor.cpp include/dActor_c.h
